...
function isCustomizationPanelAvailable() {
    $env = getenv('APP_ENV');
    return ($env === 'trial' && CheckAuthentication());
}

if(isCustomizationPanelAvailable()) {
    $buy_tpl_link = 'https://solomono.net/'.$languages_code.'/pricing.html?type=p&from=' . $_SERVER['SERVER_NAME'];
    $to_date = get_created();
  ...
  <div class="custom_panel_block">
    <ul>
      <?php if (CheckAuthentication() && !isset($_GET['side'])) { ?>
        <li>
          <a href="<?= HTTP_SERVER . '/' . $admin; ?>" target="_blank"><img
                src="<?= HTTP_SERVER; ?>/favicon.ico"><?= CUSTOM_PANEL_ADMIN_LOGIN; ?></a>
        </li>
        ...
        <span class="collapsed collapse_btn" data-toggle="collapse" data-target="#site_palette" aria-expanded="false">
          ...
          <ul class="collapse drop_menu" id="site_palette">
            <li class="change_color">
              ...
              <input class="change_color-input" data-configuration-key="MC_COLOR_1" data-color="sm-text-color"
            ...
            <li class="change_color">
                <span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"><g fill="none"
                            ...
                            fill="#495056" d="M15 10H7c-.552 0-1 .448-1 1s.448 1 1 1h8c.552 0 1-.448 1-1s-.448-1-1-1z"/><path
                            fill="#C8CACC" d="M15 14H7c-.552 0-1 .448-1 1s.448 1 1 1h8c.552 0 1-.448 1-1s-.448-1-1-1z"/><path
                            fill="#495056"
                            d="M15 0H1C.448 0 0 .448 0 1v2c0 .552.448 1 1 1h14c.552 0 1-.448 1-1V1c0-.552-.448-1-1-1z"/></g></svg>
                  <?= CUSTOM_PANEL_PALETTE_HEADER_BG; ?>
                </span>
              <input class="change_color-input" data-color="sm-bg-header" data-configuration-key="MC_COLOR_4"
            ...
            <li class="change_color">
              ...
              <input class="change_color-input" data-color="sm-bg-footer" data-configuration-key="MC_COLOR_5"
            ...
            <li class="change_color">
              ...
              <input class="change_color-input" data-color="sm-link-color" data-configuration-key="MC_COLOR_2"
            ...
            <li class="change_color">
              ...
              <input class="change_color-input" data-color="sm-btn-color" data-configuration-key="MC_COLOR_6"
            ...
            <li class="change_color">
              ...
              <input class="change_color-input" data-color="sm-btn-text-color" data-configuration-key="MC_COLOR_BTN_TEXT"
            ...
            <li class="change_color">
              ...
              <input class="change_color-input" data-color="sm-grey-color" data-configuration-key="MC_COLOR_GREY"
            ...
            <li class="change_color">
              ...
              <input class="change_color-input" data-color="sm-background" data-configuration-key="MC_COLOR_3"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
              <g fill="#FFF">
                <g>
                  ...
                  <path fill-opacity=".5" d="M7.7 7H3.3C1.478 7 0 8.008 0 9.25V10h11v-.75C11 8.008 9.522 7 7.7 7z"
                        transform="translate(0 3)"/>
                </g>
                <g>
                  <path d="M3.5 3C4.329 3 5 2.329 5 1.5S4.329 0 3.5 0 2 .671 2 1.5 2.671 3 3.5 3z"
                        transform="translate(9 3)"/>
                  <path fill-opacity=".5" d="M4.9 4H2.1C.94 4 0 4.672 0 5.5V6h7v-.5C7 4.672 6.06 4 4.9 4z"
                        transform="translate(9 3)"/>
                </g>
              </g>
            </svg>
        ...
        <span class="collapsed collapse_btn" data-toggle="collapse" data-target="#add_new" aria-expanded="false">
          ...
          <ul class="collapse drop_menu" id="add_new">
            <li>
              <a href="<?= HTTP_SERVER . '/' . $admin; ?>/products.php?cPath=&amp;action=new_product" target="_blank">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
            ...
            <li>
              <a href="<?= HTTP_SERVER . '/' . $admin; ?>/articles.php?tPath=&action=new_articles" target="_blank">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
            ...
            <li>
              <a href="<?= HTTP_SERVER . '/' . $admin; ?>/specials.php?page=1&amp;action=new" target="_blank">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                  <g fill="#495056" fill-rule="evenodd">
                    <path fill-opacity=".5"
        ...
        <li>
          <a href="<?= HTTP_SERVER . '/' . $admin; ?>/orders.php?action=create_order_form_user_selection" target="_blank">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
              <g fill="#FFF">
      ...
      <?php } else { ?>
        ...
        <li>
        <span>
            <?php $sitaname = getenv('APP_NAME'); ?>
          <a target="_blank" href="https://solomono.net/account/my_shops.php?sitename=<?php echo $sitaname; ?>&action=changePackage"
             class="buy_template_link"><?php echo IMAGE_BUTTON_BUY_TEMPLATE; ?></a>
        </span>
        </li>
      <?php } ?>
      <li>
        <span class="custom_panel_close">
          ...
          <?php if (isMobile()) echo HIGHSLIDE_CLOSE; ?>
        </span>
      </li>
    </ul>
  </div>
  <!--  <div class="custom_panel_fader"></div>-->
