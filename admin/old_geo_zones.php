                                ...
                                <table border="0" width="100%" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td class="pageHeading"><?php echo HEADING_TITLE;
                                            if (isset($_GET['zone']))
                                                echo '<br><span class="smallText">' . tep_get_geo_zone_name($_GET['zone']) . '</span>'; ?></td>
                                                ...
                                                <table border="0" width="100%" cellspacing="0" cellpadding="2">
                                                    ...
                                                    while ($zones=tep_db_fetch_array($zones_query)) {
                                                        ...
                                                        <td class="dataTableContent" align="right"><?php if (isset($sInfo) && is_object($sInfo) && ($zones['association_id']==$sInfo->association_id)) {
                                                                ...
                                                                echo '<a href="' . tep_href_link(FILENAME_GEO_ZONES, 'zpage=' . $_GET['zpage'] . '&zID=' . $_GET['zID'] . '&action=list&spage=' . $_GET['spage'] . '&sID=' . $zones['association_id']) . '">' . tep_image(DIR_WS_IMAGES . 'icon_info.gif', IMAGE_ICON_INFO) . '</a>';
                                                            } ?>&nbsp;</td>
                                                        </tr>
                                                        <?php
                                                    }
                                                    ...
                                                    <tr>
                                                        <td align="right" colspan="3"><?php if (empty($saction))
                                                                echo '<a href="' . tep_href_link(FILENAME_GEO_ZONES, 'zpage=' . $_GET['zpage'] . '&zID=' . $_GET['zID']) . '">' . tep_text_button(BUTTON_BACK_NEW) . '</a> <a href="' . tep_href_link(FILENAME_GEO_ZONES, 'zpage=' . $_GET['zpage'] . '&zID=' . $_GET['zID'] . '&action=list&spage=' . $_GET['spage'] . '&' . (isset($sInfo) ? 'sID=' . $sInfo->association_id . '&' : '') . 'saction=new') . '">' . tep_text_button(BUTTON_INSERT_NEW) . '</a>'; ?></td>
                                                    </tr>
                                                </table>
                                                <?php
                                            }else {
                                                ...
                                                <table border="0" width="100%" cellspacing="0" cellpadding="2">
                                                    ...
                                                    <tr>
                                                        <td align="right" colspan="2"><?php if (!$action)
                                                                echo '<a href="' . tep_href_link(FILENAME_GEO_ZONES, 'zpage=' . $_GET['zpage'] . '&zID=' . $zInfo->geo_zone_id . '&action=new_zone') . '">' . tep_text_button(BUTTON_INSERT_NEW) . '</a>'; ?></td>
                                                    </tr>
                                                </table>
                                                <?php
                                            }
                                        ...
                                        if ($action=='list') {
                                            switch ($saction) {
                                                case 'new':
                                                    ...
                                                    $contents[]=array(
                                                        'align'=>'center',
                                                        'text'=>'<br>' . tep_image_submit('button_insert.gif', IMAGE_INSERT) . ' <a href="' . tep_href_link(FILENAME_GEO_ZONES, 'zpage=' . $_GET['zpage'] . '&zID=' . $_GET['zID'] . '&action=list&spage=' . $_GET['spage'] . '&' . (isset($_GET['sID']) ? 'sID=' . $_GET['sID'] : '')) . '">' . tep_text_button(BUTTON_CANCEL_NEW) . '</a>'
                                                    );
                                                    break;
                                                case 'edit':
                                                    ...
                                                    $contents[]=array(
                                                        'align'=>'center',
                                                        'text'=>'<br>' . tep_image_submit('button_update.gif', IMAGE_UPDATE) . ' <a href="' . tep_href_link(FILENAME_GEO_ZONES, 'zpage=' . $_GET['zpage'] . '&zID=' . $_GET['zID'] . '&action=list&spage=' . $_GET['spage'] . '&sID=' . $sInfo->association_id) . '">' . tep_text_button(BUTTON_CANCEL_NEW) . '</a>'
                                                    );
                                                    break;
                                                case 'delete':
                                                    ...
                                                    $contents[]=array(
                                                        'align'=>'center',
                                                        'text'=>'<br>' . tep_image_submit('button_delete.gif', IMAGE_DELETE) . ' <a href="' . tep_href_link(FILENAME_GEO_ZONES, 'zpage=' . $_GET['zpage'] . '&zID=' . $_GET['zID'] . '&action=list&spage=' . $_GET['spage'] . '&sID=' . $sInfo->association_id) . '">' . tep_text_button(BUTTON_CANCEL_NEW) . '</a>'
                                                    );
                                                    break;
                                                default:
                                                    if (isset($sInfo) && is_object($sInfo)) {
                                                        ...
                                                        $contents[]=array(
                                                            'align'=>'center',
                                                            'text'=>'<a href="' . tep_href_link(FILENAME_GEO_ZONES, 'zpage=' . $_GET['zpage'] . '&zID=' . $_GET['zID'] . '&action=list&spage=' . $_GET['spage'] . '&sID=' . $sInfo->association_id . '&saction=edit') . '">' . tep_text_button(BUTTON_EDIT_NEW) . '</a> <a href="' . tep_href_link(FILENAME_GEO_ZONES, 'zpage=' . $_GET['zpage'] . '&zID=' . $_GET['zID'] . '&action=list&spage=' . $_GET['spage'] . '&sID=' . $sInfo->association_id . '&saction=delete') . '">' . tep_text_button(BUTTON_DELETE_NEW) . '</a>'
                                                        );
                                            ...
                                            switch ($action) {
                                                case 'new_zone':
                                                    ...
                                                    $contents[]=array(
                                                        'align'=>'center',
                                                        'text'=>'<br>' . tep_image_submit('button_insert.gif', IMAGE_INSERT) . ' <a href="' . tep_href_link(FILENAME_GEO_ZONES, 'zpage=' . $_GET['zpage'] . '&zID=' . $_GET['zID']) . '">' . tep_text_button(BUTTON_CANCEL_NEW) . '</a>'
                                                    );
                                                    break;
                                                case 'edit_zone':
                                                    ...
                                                    $contents[]=array(
                                                        'align'=>'center',
                                                        'text'=>'<br>' . tep_image_submit('button_update.gif', IMAGE_UPDATE) . ' <a href="' . tep_href_link(FILENAME_GEO_ZONES, 'zpage=' . $_GET['zpage'] . '&zID=' . $zInfo->geo_zone_id) . '">' . tep_text_button(BUTTON_CANCEL_NEW) . '</a>'
                                                    );
                                                    break;
                                                case 'delete_zone':
                                                    ...
                                                    $contents[]=array(
                                                        'align'=>'center',
                                                        'text'=>'<br>' . tep_image_submit('button_delete.gif', IMAGE_DELETE) . ' <a href="' . tep_href_link(FILENAME_GEO_ZONES, 'zpage=' . $_GET['zpage'] . '&zID=' . $zInfo->geo_zone_id) . '">' . tep_text_button(BUTTON_CANCEL_NEW) . '</a>'
                                                    );
                                                    break;
                                                default:
                                                    if (isset($zInfo) && is_object($zInfo)) {
                                                        ...
                                                        $contents[]=array(
                                                            'align'=>'center',
                                                            'text'=>'<a href="' . tep_href_link(FILENAME_GEO_ZONES, 'zpage=' . $_GET['zpage'] . '&zID=' . $zInfo->geo_zone_id . '&action=edit_zone') . '">' . tep_text_button(BUTTON_EDIT_NEW) . '</a> <a href="' . tep_href_link(FILENAME_GEO_ZONES, 'zpage=' . $_GET['zpage'] . '&zID=' . $zInfo->geo_zone_id . '&action=delete_zone') . '">' . tep_text_button(BUTTON_DELETE_NEW) . '</a>' . ' <a href="' . tep_href_link(FILENAME_GEO_ZONES, 'zpage=' . $_GET['zpage'] . '&zID=' . $zInfo->geo_zone_id . '&action=list') . '">' . tep_text_button(BUTTON_DETAILS_NEW) . '</a>'
                                                        );
