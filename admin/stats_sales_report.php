...
<title><?php echo TITLE; ?></title> 
    ...
    <link rel="stylesheet" href="<?php echo DIR_WS_TEMPLATES . DEFAULT_TEMPLATE; ?>/js/jqueryui/css/smoothness/jquery-ui-1.10.4.custom.min.css">
		<script src="../includes/javascript/lib/jquery-1.7.1.min.js"></script>
		<script src="includes/javascript/jquery-ui-1.7.2.custom.min.js"></script>
    <script>
			$(function(){
