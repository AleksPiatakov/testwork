...
define('NAVBAR_TITLE', 'Реєстрація клієнта');
define('HEADING_TITLE', 'Реєстрація клієнта');
define('HEADING_NEW', 'Оформлення замовлення');
...
define('NAVBAR_NEW_TITLE', 'Оформлення замовлення');
