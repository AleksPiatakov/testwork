...
define('TOOLTIP_GOOGLE_SITE_VERIFICATION_KEY', 'Key provided by Google (you only need to insert the key itself)');
...
define('BOX_PRODUCTS_STATS_MENU_ITEM', 'Product Statistics');
...
define('INFO_ICON_ENABLE_SMTP', '開機時，檢查 SMTP 的設置');
define('SMTP_CONF_TITLE', 'SMTP 設置');
...
define('NWPOSHTA_DELIVERY_TITLE', '新的邮件递送地址');
