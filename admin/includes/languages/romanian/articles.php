...
define('TEXT_COUNT_SURE_DELL', 'This section contains the %s and %s articles. Are you sure?');
...
define('TEXT_ARTICLES_LINK', 'Сustom URL link');
...
define('TEXT_ARTICLES_URL', 'Article URL text:');
define('TEXT_ARTICLES_URL_WITHOUT_HTTP', '<small>(without http://)</small>');

define('TEXT_ARTICLES_IMAGE', 'Image');
define('TEXT_ARTICLES_DEL_IMAGE', 'Delete image');
define('TEXT_ARTICLES_SORT', 'Sort order');
define('TEXT_SHOW_IN_SITEMAP', 'Afișați în sitemap');
...
define('TEXT_ARTICLES_IMAGE_MOBILE','Mobile image');
?>
