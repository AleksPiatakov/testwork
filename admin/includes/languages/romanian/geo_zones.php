...
define('HEADING_TITLE', 'Zonele fiscale');

define('TABLE_HEADING_COUNTRY', 'Country');
define('TABLE_HEADING_COUNTRY_ZONE', 'Zone');
define('TABLE_HEADING_COUNTRY_STATE', 'State');
...
define('TEXT_ALL_TAX_ZONES', 'Toate zonele fiscale');
...
define('BUTTON_DETAILS_NEW', 'details');
