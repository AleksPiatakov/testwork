...
define('TEXT_PROD_LOAD_FILES','Încărcați fișiere:');
define('TEXT_ALOWED_FILE_TYPES','Tipuri de fișiere permise:');
define('TEXT_PROD_FILES_DRAG','Trage fisiere aici');
define('TEXT_PROD_DOWNLOADS','Fișiere de descărcat');
define('TEXT_IS_DOWNLOAD_PRODUCT','Produs electronic:');
...
define('TEXT_QTY_PRO_QUANTITY_LABEL', 'Cantitate');
define('TEXT_QTY_PRO_COMBINATION_PRICE_LABEL', 'Preț');
define('TEXT_QTY_PRO_VENDOR_CODE_LABEL', 'Cod furnizor');

// EOF MaxiDVD: Added For Ultimate-Images Pack!
define('HEADING_TITLE', 'Categories / Products');
define('HEADING_TITLE_SEARCH', 'Search:');
define('HEADING_TITLE_GOTO', 'Go To:');
define('TEXT_EDITED_FOR_SEO', 'Edited for SEO');
...
define('TEXT_EMPTY_ATTRIBUTES', 'Mai întâi, adăugați un atribut produsului cu cel puțin două valori.');
...
define('BUTTON_QUICK_VIEW', 'Vizualizare rapidă');
define('TEXT_LINK_TO_YOUTUBE', 'Legătură către videoclipul Youtube');
define('TEXT_IMAGE_PREVIEW', 'Previzualizare');
define('TEXT_CHOOSE_ON_SERVER', 'Alegeți pe server');