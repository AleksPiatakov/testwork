...
define('MODULE_PAYMENT_BANK_CART_TRANSFER_STATUS_TITLE', 'Plata anticipată pe card');
define('MODULE_PAYMENT_BANK_CART_TRANSFER_STATUS_DESC', 'Doriți să utilizați modulul Abonament card? 1 - da, 0 - nu');
define('MODULE_PAYMENT_BANK_CART_TRANSFER_1_TITLE', 'Numele băncii');
define('MODULE_PAYMENT_BANK_CART_TRANSFER_1_DESC', 'Introduceţi numele băncii');
define('MODULE_PAYMENT_BANK_CART_TRANSFER_2_TITLE', 'Număr card');
define('MODULE_PAYMENT_BANK_CART_TRANSFER_2_DESC', 'Introduceţi numărul cardului dvs.');
define('MODULE_PAYMENT_BANK_CART_TRANSFER_3_TITLE', 'Destinatar');
define('MODULE_PAYMENT_BANK_CART_TRANSFER_3_DESC', 'Destinatarul plății');
define('MODULE_PAYMENT_BANK_CART_SORT_ORDER_TITLE', 'Ordine de sortare');
define('MODULE_PAYMENT_BANK_CART_SORT_ORDER_DESC', 'Ordine sortare module');
...
define('MODULE_SHIPPING_EXPRESS_SHIPPING_PRICE_TEXT_TITLE', 'Textul prețului de livrare');
define('MODULE_SHIPPING_EXPRESS_SHIPPING_PRICE_TEXT_DESC', 'Lăsați necompletat dacă doriți să utilizați prețul specificat în câmpul cost');
...
define('MODULE_SHIPPING_NWPOCHTA_SHIPPING_PRICE_TEXT_TITLE', 'Textul prețului de livrare');
define('MODULE_SHIPPING_NWPOCHTA_SHIPPING_PRICE_TEXT_DESC', 'Lăsați necompletat dacă doriți să utilizați prețul specificat în câmpul cost');
...
define('SHIPPING_TAB_TITLE', 'Livrare');
define('SHIPPING_TO_PAYMENT_TAB_TITLE', 'Expediere pentru a plăti');
define('SHIPPING_TO_FIELDS_TAB_TITLE', 'Expediere către câmpuri');
define('SHIPPING_UPDATE_WAREHOUSES_TITLE', 'Actualizați depozitele');
define('MODULE_SHIPPING_NWPOSHTANEW_STATUS_TITLE', 'Activează modul New Mail');
define('MODULE_SHIPPING_NWPOSHTANEW_STATUS_DESC', 'Doriți să activați modulul New Mail?');
define('MODULE_SHIPPING_NWPOSHTANEW_COST_TITLE', 'Cost');
define('MODULE_SHIPPING_NWPOSHTANEW_CUSTOM_NAME_TITLE', 'Custom Name');
define('MODULE_SHIPPING_NWPOSHTANEW_CUSTOM_NAME_DESC', 'Lăsați acest câmp necompletat dacă doriți să utilizați numele implicit');
define('MODULE_SHIPPING_NWPOSHTANEW_COST_DESC', 'Costul utilizării acestei metode de expediere.');
define('MODULE_SHIPPING_NWPOSHTANEW_TAX_CLASS_TITLE', 'Tax');
define('MODULE_SHIPPING_NWPOSHTANEW_TAX_CLASS_DESC', 'Utilizați taxa.');
define('MODULE_SHIPPING_NWPOSHTANEW_ZONE_TITLE', 'Zona');
define('MODULE_SHIPPING_NWPOSHTANEW_ZONE_DESC', 'Dacă este selectată o zonă, acest modul de expediere va fi vizibil numai pentru clienții din zona selectată.');
define('MODULE_SHIPPING_NWPOSHTANEW_SORT_ORDER_TITLE', 'Ordine de sortare');
define('MODULE_SHIPPING_NWPOSHTANEW_SORT_ORDER_DESC', 'Ordinea sortării modulelor.');
define('MODULE_SHIPPING_NWPOSHTANEW_API_KEY_TITLE', 'Cheia API');
define('MODULE_SHIPPING_NWPOSHTANEW_API_KEY_DESCRIPTION', 'Poate fi necesară actualizarea depozitelor');
define('MODULE_SHIPPING_NWPOSHTANEW_SHOW_SHIPPING_COST_STATUS_TITLE', 'Arată costul de transport');
define('MODULE_SHIPPING_NWPOSHTANEW_SHIPPING_PRICE_TEXT_TITLE', 'Textul prețului de livrare');
define('MODULE_SHIPPING_NWPOSHTANEW_SHIPPING_PRICE_TEXT_DESC', 'Lăsați necompletat dacă doriți să utilizați prețul specificat în câmpul cost');
