...
define('TABLE_HEADING_ORDER_STATUS_TEXT','Order status text');
define('TABLE_HEADING_DEFAULT', 'Default');
define('TABLE_HEADING_ACTION', 'Action');
define('TABLE_HEADING_COLOR', 'Color');
define ('TABLE_HEADING_STATUS_SHOW', 'Show on admin home page');
...
define('ERROR_ORDER_STATUS_IS_DEFAULT', "You can't delete default order status");
define('TABLE_HEADING_DOWNLOADS', 'Permite descărcarea de produse electronice');