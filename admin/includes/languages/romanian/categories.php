...
define('TEXT_EDIT_CATEGORIES_DISPLAY_PRODUCTS', 'Afișați produsele:');
...
define('TEXT_INFO_DELETE_FROM_CATEGORY', 'Selectați categoria din care doriți să eliminați acest produs');
...
define('BUTTON_NEW_CATEGORY_NEW', 'New category');
define('BUTTON_NEW_PRODUCT_NEW', 'New product');
...
define('TEXT_EDIT_CATEGORIES_DISPLAY_PRODUCTS_NOTHING','Nimic');
define('TEXT_EDIT_CATEGORIES_DISPLAY_PRODUCTS_ALL','Toate produsele din subcategorii');
define('TEXT_EDIT_CATEGORIES_DISPLAY_PRODUCTS_TOP','TOP vânzări din această categorie');
define('TEXT_EDIT_CATEGORIES_DISPLAY_PRODUCTS_RECOMMENDED','Recomandat pentru această categorie');
define('TEXT_EDIT_CATEGORIES_DISPLAY_PRODUCTS_NEW','Noutăți din această categorie');
define('TEXT_ID_XML_CATEGORY','ID categorie XML');
define('TEXT_VENDOR_XML_CATEGORY','Vendor categorie XML');
define('ERROR_SYS_CATEGORY_EXIST','ID-ul XML al categoriei %s este deja ocupat de <a href="'.DIR_WS_ADMIN . 'categories.php?cID=%s&action=edit_category" target="_blank">o altă categorie</a>');
?>