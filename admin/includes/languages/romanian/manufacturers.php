...
define('TABLE_HEADING_META_KEYWORDS', 'Keywords');
...
define('TEXT_MANUFACTURERS_SORT', 'Sort:');
...
define('TEXT_DELETE_PRODUCTS', 'Delete products from this manufacturer? (including products on special, upcoming products)');
...
define('TEXT_MANUFACTURERS_H1', 'Producător H1');
define('TEXT_MANUFACTURERS_SEO_TOP', 'Seo text de sus');
...
define('TEXT_MANUFACTURERS_FEATURED', 'Producători prezentați:');
?>