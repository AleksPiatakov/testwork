...
define('EMAIL_TEXT_SUBJECT', 'Enquiry From '.  STORE_NAME );
define('EMAIL_TEXT_SALUTATION', 'Dear ' );
define('EMAIL_TEXT_NEWCUST_INTRO', "\n\n" . 'Sorry to trouble you and Thank you for visiting ' . STORE_NAME .
    ' and considering us for your purchase. ');
define('EMAIL_TEXT_CURCUST_INTRO', "\n\n" . 'Sorry to trouble you but we would like to thank you for Visiting ' .
    STORE_NAME . ' recently. ');
define('EMAIL_TEXT_BODY_HEADER',
    'We noticed that during a visit to our store you placed ' .
    'the following item(s) in your shopping basket, but did not complete ' .
    'the transaction.' . "\n\n" .
...
define('RCS_BASE_DAYS', 'Look back days	');
?>
