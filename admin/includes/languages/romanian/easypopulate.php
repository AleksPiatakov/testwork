...
define('EASY_LABEL_CREATE', 'Export file');
...
define('EASY_R_INFO', 'short desc.');
define('EASY_R_DESC', 'description');
define('EASY_R_CAT', 'category');
define('EASY_R_LANGUAGE', 'limba');
define('EASY_R_MODEL', 'model');
define('EASY_R_IMAGES', 'images');
define('EASY_R_MANUF', 'manufacturer');
define('EASY_R_DISC', 'discount');
define('EASY_R_PRICE', 'price');
define('EASY_R_QTY', 'qty');
define('EASY_R_WEIGHT', '_weight_');
define('EASY_R_DATE', 'date');
define('EASY_R_STATUS', 'status');
define('EASY_R_STATUS_ACT', 'active');
define('EASY_R_STATUS_NOACT', 'noactive');
define('EASY_R_STATUS_DELETE', 'delete');
define('EASY_R_DOWNLOAD', 'You may download your file here');
define('EASY_R_NORMAL', 'Normal');
define('EASY_R_ADD', 'Add lines');
define('EASY_R_REFRESH', 'Refresh');
define('EASY_R_DEL', 'Delete');
define('EASY_R_FULLFILE', 'Full file');
define('EASY_R_ID_PRICE', 'Model/Price/Qty');
define('EASY_R_DOWN_NOW', 'Download now');
define('EASY_R_DOWN_CREATE', 'Create and download');
define('EASY_R_TMP_DIR', 'Create in temporary folder');
define('EASY_R_ALL', 'All');
define('EASY_R_PRICEQTY', 'Price/Qty');
define('EASY_R_CATS', 'Categories');
define('EASY_R_ATTRS', 'Attributes');
define('EASY_R_FILE3', 'file');
define('EASY_R_SORT', 'Sort order');
define('EASY_R_FILTER', 'Filtration');
define('EASY_LABEL_ALGORITHM', 'Algoritm de import');
define('EASY_LABEL_DELIMITER', 'Delimitator');
define('EASY_SELECT_FILE', 'Selectați un fișier');
define('EASY_EXPORT_DATA', 'Export de date');
define('EASY_LABEL_EXPORT_FULL_ATTR_INF', 'Descărcați informații complete despre atribute');
define('EASY_LABEL_IMPORT_FULL_ATTR_INF', 'Descărcați informații complete despre atribute');
