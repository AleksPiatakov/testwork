...
define('TABLE_HEADING_LANGUAGE_ORDER', 'Sort Order');
...
define('TEXT_INFO_LANGUAGE_FROM_DIR', 'Copy translate from directory:');
...
define('TEXT_INFO_HEADING_ENABLE_MULTILANGUAGE', 'Enable multilanguage');
...
define('ERROR_STATUS_DEFAULT_LANGUAGE', 'Error: The default language can not be change status. Please set another language as default, and try again.');
define('ERROR_STATUS_SELECTED_LANGUAGE', 'Error: In the current language can not be change status.  Please set another language, and try again.');
define('REQUIRED_FIELDS_ERROR', 'Vă rugăm să completați toate câmpurile obligatorii');
