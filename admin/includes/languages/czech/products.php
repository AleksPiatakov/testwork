...
define('TEXT_XSELLS_ADD', 'Přidat xsell podle modelu produktů:');
define('TEXT_XSELLS_ADD_BUTTON', 'Přidat');
define('TEXT_XSELLS_DEL_BUTTON', 'Smazat');
...
define('TEXT_EDITED_FOR_SEO', 'Upraveno pro SEO');
...
define('TEXT_NEW_CATEGORY_INTRO', 'Prosíme vyplňte následující informace pro novou kategorii');
...
define('TEXT_WEIGHT_HELP', '<span class="main"><b><font color="red">Upozornění:</font></b> Hmotnost musí být větší než 0. Pro virtuální produkty (stáhnoutpoživatelné produkty) hmotnost musí být 0.</span>');
...
define('TEXT_PROD_TEXTS','Texty');
define('TEXT_PROD_IMGS','Obrázky');
define('TEXT_PROD_VIDEO','Video');
define('TEXT_PROD_ATTRS','Atributy');
define('TEXT_PROD_LINK','Odkaz');
define('TEXT_PROD_PRICE','Cena');
define('TEXT_PROD_TOP','TOP');
define('TEXT_PROD_NEW','NEW');
define('TEXT_PROD_AKC','PROMO');
define('TEXT_PROD_WE','Hmotnost');
define('TEXT_PROD_SORT','Pořadí řazení');
define('TEXT_PROD_QTY','Množství');
define('TEXT_PROD_MINORD','Minimální množství objednávky');
define('TEXT_PROD_IMGS2','Obrázky produktů');
define('TEXT_PROD_IMGS3','x');
define('TEXT_PROD_IMGS_OR','nebo');
define('TEXT_PROD_IMGS_DRAG','Sem přetáhněte obrázky');
define('TEXT_PROD_COLOR','Barva');
define('TEXT_PROD_CROP','Oříznout');
define('TEXT_PROD_SAVE_BEFORE','Před přidáním obrázků uložte produkt.');
define('TEXT_PROD_LOAD_IMGS','Nahrát obrázky');
define('TEXT_PROD_LOAD_IMGS_BUT','Nahrát');
define('TEXT_PROD_ON','on');
define('TEXT_PROD_OFF','off');
define('TEXT_DISCOUNT','Sleva');
define('TEXT_RECIPROCAL_LINK','Vzájemný odkaz');

//Knoflík
define('BUTTON_BACK_NEW', 'zpět');

define('TEXT_PROD_DOWNLOADS','Soubory ke stažení');
define('TEXT_IS_DOWNLOAD_PRODUCT','Elektronický produkt:');
define('TEXT_PRODUCT_STATUS','Status');
define('TEXT_EDIT_ROBOTS_STATUS', 'Stav indexu robotů');
define('TEXT_PROD_LOAD_FILES','Načíst soubory:');
define('TEXT_ALOWED_FILE_TYPES','Povolené typy souborů:');
define('TEXT_PROD_FILES_DRAG','Sem přetáhněte soubory');
define('TEXT_DEFINE_CATEGORY_ROBOTS_STATUS', 'index, follow/noindex, nofollow');
define('TEXT_EMPTY_ATTRIBUTES', 'Nejprve přidejte atribut k produktu s alespoň dvěma hodnotami.');
define('TEXT_CHOOSE_ON_SERVER', 'Vyberte si na serveru');