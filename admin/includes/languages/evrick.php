...
define('GOOGLE_FEED_CHOOSE_ALL_PRODUCTS_TITLE', 'Экспортировать в Google Feed все товары');
...
define('INTEGRATION_CONF_TITLE', 'Интеграции');
...
define('TOOLTIP_SMS_CODE_1', 'Предоставляет sms-провайдер.');
...
define('HEADER_BUY_TEMPLATE_LINK','Купить этот магазин');
