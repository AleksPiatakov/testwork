<?php
/*
  $Id: order_edit_ukrainian.php,v 1.1 2003/09/24 14:33:18 wilt Exp $
...
define('JS_ADDRESS', '* Поле Адрес и номер дома должно содержать как минимум ' . ENTRY_STREET_ADDRESS_MIN_LENGTH . ' символов.\n');
...
define('BOX_MANUAL_ORDER_CREATE_ORDER', 'Створити замовлення');
?>