...
define('TEXT_PROD_LOAD_FILES','Load files:');
define('TEXT_ALOWED_FILE_TYPES','Allowed file types:');
define('TEXT_PROD_FILES_DRAG','Drag files here');
define('TEXT_PROD_DOWNLOADS','Files to download');
define('TEXT_IS_DOWNLOAD_PRODUCT','Electronic product:');
...
define('TEXT_QTY_PRO_QUANTITY_LABEL', 'Quantity');
define('TEXT_QTY_PRO_COMBINATION_PRICE_LABEL', 'Price');
define('TEXT_QTY_PRO_VENDOR_CODE_LABEL', 'Vendor Code');
...
define('TEXT_EMPTY_ATTRIBUTES', 'First, add an attribute to the product with at least two values.');
...
define('TEXT_LINK_TO_YOUTUBE', 'Link to Youtube video');
define('TEXT_IMAGE_PREVIEW', 'Preview');
define('TEXT_CHOOSE_ON_SERVER', 'Choose on server');