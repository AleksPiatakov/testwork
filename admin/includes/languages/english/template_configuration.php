...
define('MAX_DISPLAY_SEARCH_RESULTS_TITLE_INFO_DEL', 'Delete value');
define('MAX_DISPLAY_SEARCH_RESULTS_TITLE_INFO_ADD', 'Add value');
define('MC_PRODUCT_QNT_IN_ROW_INFO_0', 'Phone < 768px. The value \'3\' is equal to \'2\' if ≤ 480px');
define('MC_PRODUCT_QNT_IN_ROW_INFO_1', 'Tablet (vertical) < 992px');
...
define('SHOW_SHORTCUT_LEFT_TREE', 'Show collapsed left tree');
define('F_FOOTER_CATEGORIES', 'Categories in the footer');
define('P_SHOW_PROD_QTY_ON_PAGE', 'Show remaining stock');
