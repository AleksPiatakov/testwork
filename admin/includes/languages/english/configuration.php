...
define('TABLE_HEADING_CONFIGURATION_SHOW_FIELD', 'Show field');
define('TABLE_HEADING_CONFIGURATION_REQUIRED_VALUE', 'Required');
...
// Мой магазин
define('ONEPAGE_ADDRESS_TYPE_POSITION_TITLE', 'Address order');
define('REVIEWS_WRITE_ACCESS_TITLE', 'Allow only registered users to write reviews');
define('MYSQL_PERFORMANCE_TRESHOLD_TITLE', 'MySQL Performance Log time "from"');
define('MINIFY_CSSJS_TITLE', 'Minify CSS and JS');
define('MENU_LOCATION_TITLE', 'Admin menu location: ');
define('MENU_TOP_LOCATION', 'Top');
define('MENU_LEFT_LOCATION', 'Left');
define('MENU_LEFT_MIN_LOCATION', 'Left collapsed');
define('MINIFY_CSSJS_0_TITLE', 'Not minify');
define('MINIFY_CSSJS_1_TITLE', 'Minify now');
define('MINIFY_CSSJS_2_TITLE', 'Use minified file');
define('IMAGE_CACHE_TITLE', 'Change IMAGE_CACHE');
define('IMAGE_CACHE_0_TITLE', 'Switch off');
define('IMAGE_CACHE_1_TITLE', 'Enable');
define('SEO_URLS_CACHE_RESET_TITLE', 'Reset cache for SEO URLs');
...
define('SEO_ADD_PARENT_CATEGORIES_TO_URL_TITLE', 'Add parent categories ids to URL');
...
define('USE_CRITICAL_CSS_TITLE', 'Use critical CSS');
define('WATER_MARK_TITLE', 'Watermarking');
define('STORE_NAME_TITLE', 'Store Name');
//define('MULTICOLOR_NAME_TITLE' , 'Attribute name (MULTICOLOR)');
define('STORE_OWNER_TITLE', 'Store Owner');
define('STORE_ADDRESS_TITLE', 'Store Address');
...
define('SEO_FILTER_TITLE', 'Enable SEO filters');
...
define('ENABLE_DEBUG_PAGE_SPEED_TITLE', 'Enable page load debug');
define('SET_WWW_TITLE', 'Redirect to www');
define('WWW_TOO_MANY_REDIRECTS', 'Too many redirects, value unchanged');
...
define('ENTRY_SUBURB_MIN_LENGTH_TITLE', 'Suburb');
...
define('SLIDER_HEIGHT_TITLE', 'Slider height');
...
define('STOCK_DISABLE_NON_EXISTENT_PRODUCT_ON_CHECKOUT_TITLE', 'Disable redeemed products');
...
define('XPRICES_NUM_DESC',
    'Number of prices per products<br><br><b>WARNING: Changing this value will delete prices entry in products table!</b><br><br><b>Every groups that use a deleted price will use product default price.</b>');
define('NEW_SIGNUP_GIFT_VOUCHER_AMOUNT_DESC',
    'Welcome Gift Voucher Amount: If you do not wish to send a Gift Voucher in your create account email put 0 for no amount else if you do place the amount here i.e. 10.00 or 50.00 no currency signs');
...
define('MAX_MANUFACTURERS_LIST_DESC',
    'Used in manufacturers box; when this value is \'1\' the classic drop-down list will be used for the manufacturers box. Otherwise, a list-box with the specified number of rows will be displayed.');
...
define('PRODUCT_LISTING_DISPLAY_STYLE_DESC',
    'Choose which Style you would like use to display your products on the Product Listing Pages.<br><br>Whichever style you choose, make sure you configure the appropriate settings for the style of listing you have selected.');
...
define('STOCK_DISABLE_NON_EXISTENT_PRODUCT_ON_CHECKOUT_DESC', 'Disable products with quantity 0 after purchase');
...
define('WARN_BEFORE_DOWN_FOR_MAINTENANCE_DESC',
    'Give a WARNING some time before you put your website Down for Maintenance<br>(true=on false=off)<br>If you set the \'Down For Maintenance: ON/OFF\' to true this will automaticly be updated to false');
...
define('PAGE_CACHE_DEBUG_MODE_DESC',
    'Turn on the global debug output (located at the footer). This affects ALL browsers and is NOT for live shops! You can turn on debug mode JUST for your browser by adding ?debug=1 to your URL.');
...
//checkout
define('ONEPAGE_CHECKOUT_ENABLED_TITLE', 'Enable One Page Checkout');
define('ONEPAGE_ACCOUNT_CREATE_TITLE', 'Account Creation');
define('ONEPAGE_SHOW_CUSTOM_COLUMN_TITLE', 'Show Custom Right Column');
define('ONEPAGE_LOGIN_REQUIRED_TITLE', 'Require Login');
define('ONEPAGE_SHOW_OSC_COLUMNS_TITLE', 'Show Oscommerce Columns');
...
define('FACEBOOK_AUTH_STATUS_TITLE', 'Facebook Authorization');

define('RCS_BASE_DAYS_TITLE', 'Look back days	');
define('RCS_SKIP_DAYS_TITLE', 'Skip days');
define('RCS_REPORT_DAYS_TITLE', 'Use Calculated taxes');
define('RCS_INCLUDE_TAX_IN_PRICES_TITLE', 'Use Fixed tax rate');
define('RCS_USE_FIXED_TAX_IN_PRICES_TITLE', 'Fixed Tax Rate	');
...
define('RCS_CURCUST_COLOR_TITLE', ' Current Customer	');
...
define('RCS_PENDING_SALE_STATUS_TITLE', 'Pending sales statuses	');
define('RCS_REPORT_EVEN_STYLE_TITLE', 'Report Even Row Style');
define('RCS_REPORT_ODD_STYLE_TITLE', 'Report Odd Row Style	');


define('DEFAULT_DATE_FORMAT_TITLE', "Default date format title");

define('DISPLAY_PRICE_WITH_TAX_CHECKOUT_TITLE', 'Calculate tax in Checkout');

define('SET_JIVOSITE_TITLE', 'Online consultant');
define('INSTAGRAM_LINK_SLIDE_TITLE', 'Instagram link slide');

define('STORE_BANK_INFO_TITLE', 'Bank information for invoice');

define('JIVOSITE_WIDGET_ID_TITLE', 'JivoSite widget ID');
define('STORE_SCRIPTS_TITLE', 'Including custom JS');
define('STORE_METAS_TITLE', 'Including custom Meta tags in head');

define('CHANGE_BY_GEOLOCATION_TITLE', 'Switching currency and language depending on geolocation');
define('GET_BROWSER_LANGUAGE_TITLE', 'Switch site to browser language');

define('FACEBOOK_GOALS_ADD_PAYMENT_INFO_TITLE', 'Goal \'AddPaymentInfo\' - filling payment information');
define('FACEBOOK_GOALS_ADD_TO_WISHLIST_TITLE', 'Goal \'AddToWishlist\' - add to wishlist');
define('FACEBOOK_GOALS_CONTACT_US_REQUEST_TITLE', 'Goal \'Lead\' - request on contact us page');
define('FACEBOOK_GOALS_VIEW_CONTENT_TITLE', 'Goal \'ViewContent\' - view product page');
define('FACEBOOK_GOALS_SUCCESS_PAGE_TITLE', 'Goal \'Purchase\' - page after order confirmed');
define('FACEBOOK_GOALS_CHECKOUT_PROCESS_TITLE', 'Goal \'InitiateCheckout\' - checkout page');
define('FACEBOOK_GOALS_SEARCH_RESULTS_TITLE', 'Goal \'Search\' - search result page');
define('FACEBOOK_GOALS_COMPLETE_REGISTRATION_TITLE', 'Goal \'CompleteRegistration\' - when customer registered');
define('FACEBOOK_GOALS_ADD_TO_CART_TITLE', 'Goal \'AddToCart\' - add to cart');
define('FACEBOOK_GOALS_PAGE_VIEW_TITLE', 'Goal \'PageView\' - on each page');
define('FACEBOOK_GOALS_CLICK_FAST_BUY_TITLE', 'Goal \'FastBuy\' - when customer click \'Quick order\' button on product page');
define('FACEBOOK_GOALS_CLICK_ON_CHAT_TITLE', 'Goal \'ClickChat\' - when customer click Chat button');
define('FACEBOOK_GOALS_CALLBACK_TITLE', 'Goal \'Callback\' - when customer click \'Callback\' button on site header');
define('FACEBOOK_GOALS_FILTER_TITLE', 'Goal \'filter\' - when customer uses a filter to search for products');
define('FACEBOOK_GOALS_SUBSCRIBE_TITLE', 'Goal \'Subscribe\' - when customer has subscribed');
define('FACEBOOK_GOALS_LOGIN_TITLE', 'Goal \'login\' - when customer has logged');
define('FACEBOOK_GOALS_ADD_REVIEW_TITLE', 'Goal \'add_review\' - when customer added review');
define('FACEBOOK_GOALS_PHONE_CALL_TITLE', 'Goal \'PhoneCall\' - when customer click on phone number on site header');
define('FACEBOOK_GOALS_CLICK_ON_BUG_REPORT_TITLE', 'Goal \'BugReport\' - when customer click on \'Send bug message\' on site footer');
...
define('GOOGLE_ANALYTICS_AND_TAGS_MODULE_ENABLED_TITLE', 'Enable Google Analytics');
...
define('GOOGLE_GOALS_PAGE_VIEW_TITLE', 'Target \'page_view\' is to view each page');
define('GOOGLE_GOALS_ADD_TO_CART_TITLE', 'Target \'add_to_cart\' is when a customer adds an item to the cart');
define('GOOGLE_GOALS_ON_CHECKOUT_TITLE', 'Target \'checkout_view\' is to view the checkout page');
define('GOOGLE_GOALS_CHECKOUT_PROCESS_TITLE', 'Target \'checkout_progress\' - the customer has successfully placed an order');
define('GOOGLE_GOALS_CHECKOUT_SUCCESS_TITLE', 'The goal of \'checkout_success\' is to view the page after order confirmation');
define('GOOGLE_GOALS_CLICK_FAST_BUY_TITLE', 'Target \'fast_buy\' - when a customer clicks the "Quick order" button on the product page');
define('GOOGLE_GOALS_LOGIN_TITLE', 'Target \'login\' is when the client is logged in');
define('GOOGLE_GOALS_ADD_REVIEW_TITLE', 'Target \'add_review\' is when a customer added a review');
define('GOOGLE_GOALS_FILTER_TITLE', 'The target of \'filter\' is when a customer uses a filter to search for products');
define('GOOGLE_GOALS_CALLBACK_TITLE', 'Target \'callback\' - when the client clicks the \'Callback\' button in the site header');
define('GOOGLE_GOALS_CLICK_ON_PHONE_TITLE', 'Target \'phone_call\' is when the client clicks on the phone icon');
define('GOOGLE_GOALS_CLICK_ON_CHAT_TITLE', 'Target \'click_chat\' is when client clicks on chat');
define('GOOGLE_GOALS_CONTACT_US_TITLE', 'Target \'contact_us\' - when the client made a request on the contact page');
define('GOOGLE_GOALS_SUBSCRIBE_TITLE', 'Target \'subscribe\' - when the client subscribed');
define('GOOGLE_GOALS_CLICK_ON_BUG_REPORT_TITLE', 'The target of \'bug_report\' is when the client clicks \'Submit Bug Report\' in the site footer');

define('GOOGLE_ECOMM_SUCCESS_PAGE_TITLE', 'Ecommerce Purchase \'purchase\' - page view after order confirmation');
define('GOOGLE_ECOMM_CHECKOUT_PAGE_TITLE', 'Ecommerce Target \'cart\' - Checkout Page');
define('GOOGLE_ECOMM_PRODUCT_DETAIL_PAGE_TITLE', 'The \'product\' ecommerce goal is to view the product page');
define('GOOGLE_ECOMM_SEARCH_RESULTS_TITLE', 'Ecommerce goal \'searchresults\' - view search results page');
define('GOOGLE_ECOMM_HOME_PAGE_TITLE', 'Ecommerce goal \'home\' is to view the product page');
define('GOOGLE_ECOMM_CLICK_FAST_BUY_TITLE', 'Ecommerce Goal \'Purchase\' - when customer accept \'Quick order\' on product page');

define('DOMEN_URL_TITLE', 'Domain name');
define('DOMEN_URL_DESC', 'You can set your own domen name');
define('STOCK_ALLOW_CHECKOUT_WITH_ATTR_COUNT_0_TITLE', 'Allow to buy with 0 in product attributes');
define('STOCK_ALLOW_CHECKOUT_WITH_ATTR_COUNT_0_DESC', 'Allow to buy when quantity is 0 in product attributes');
define('STORE_TIME_ZONE_TITLE', 'Time zone');
define('SSL_EXIST', 'Certificate issued');
define('SSL_NON_EXIST', 'Issue certificate');
define('SSL_ARE_YOU_SURE', 'This will generate a personal SSL certificate for the domain. Are you sure?');
define('QUICK_ORDER_ENABLED_TITLE', 'Quick order button');