...
define('MODULE_PAYMENT_LIQPAY_DEFAULT_ORDER_STATUS_ID_TITLE', 'Set default order status');
define('MODULE_PAYMENT_LIQPAY_DEFAULT_ORDER_STATUS_ID_DESC', 'Set default order status');

define('MODULE_PAYMENT_MONO_STATUS_TITLE', 'Allow payment module Monobank');
define('MODULE_PAYMENT_MONO_STATUS_DESC', 'Allow payment module Monobank?');
define('MODULE_PAYMENT_MONO_ID_TITLE', 'X-Token');
define('MODULE_PAYMENT_MONO_ID_DESC', 'Enter your identification number (X-Token).');
define('MODULE_PAYMENT_MONO_SORT_ORDER_TITLE', 'The sort order');
define('MODULE_PAYMENT_MONO_SORT_ORDER_DESC', 'Module sort order.');
define('MODULE_PAYMENT_MONO_ZONE_TITLE', 'Payment zone');
define('MODULE_PAYMENT_MONO_ZONE_DESC', 'If a zone is selected, then this payment module will be visible only to buyers from the selected zone.');
define('MODULE_PAYMENT_MONO_ORDER_STATUS_ID_TITLE', 'Specify the paid order status');
define('MODULE_PAYMENT_MONO_ORDER_STATUS_ID_DESC', 'Specify the paid order status');

define('MODULE_PAYMENT_MONO_DEFAULT_ORDER_STATUS_ID_TITLE', 'Specify a default order status');
define('MODULE_PAYMENT_MONO_DEFAULT_ORDER_STATUS_ID_DESC', 'Specify a default order status');
...
define('MODULE_PAYMENT_BANK_CART_TRANSFER_STATUS_TITLE', 'Prepayment to the card');
define('MODULE_PAYMENT_BANK_CART_TRANSFER_STATUS_DESC', 'Do you want to use the Card Subscription module? 1 - yes, 0 - no');
define('MODULE_PAYMENT_BANK_CART_TRANSFER_1_TITLE', 'Bank Name');
define('MODULE_PAYMENT_BANK_CART_TRANSFER_1_DESC', 'Enter the name of the bank');
define('MODULE_PAYMENT_BANK_CART_TRANSFER_2_TITLE', 'Card number');
define('MODULE_PAYMENT_BANK_CART_TRANSFER_2_DESC', 'Enter your card number');
define('MODULE_PAYMENT_BANK_CART_TRANSFER_3_TITLE', 'Recipient');
define('MODULE_PAYMENT_BANK_CART_TRANSFER_3_DESC', 'Payment recipient');
define('MODULE_PAYMENT_BANK_CART_SORT_ORDER_TITLE', 'Sort order');
define('MODULE_PAYMENT_BANK_CART_SORT_ORDER_DESC', 'Module sort order');
...
define('MODULE_SHIPPING_NWPOCHTA_STATUS_TITLE', 'Enable method');
define('MODULE_SHIPPING_NWPOCHTA_STATUS_DESC', 'Do you want to enable this method?');
define('MODULE_SHIPPING_NWPOCHTA_CUSTOM_NAME_TITLE', 'Custom module name');
define('MODULE_SHIPPING_NWPOCHTA_CUSTOM_NAME_DESC', 'Leave empty if you want to use default module name');
...
define('MODULE_SHIPPING_NWPOSHTANEW_STATUS_TITLE', 'Enable New Mail module');
define('MODULE_SHIPPING_NWPOSHTANEW_STATUS_DESC', 'Do you want to enable the New Mail module?');
define('MODULE_SHIPPING_NWPOSHTANEW_COST_TITLE', 'Cost');
define('MODULE_SHIPPING_NWPOSHTANEW_CUSTOM_NAME_TITLE', 'Custom Title');
define('MODULE_SHIPPING_NWPOSHTANEW_CUSTOM_NAME_DESC', 'Leave this field blank if you want to use the default name');
define('MODULE_SHIPPING_EXPRESS_SHIPPING_PRICE_TEXT_TITLE', 'Delivery price text');
define('MODULE_SHIPPING_EXPRESS_SHIPPING_PRICE_TEXT_DESC', 'Leave blank if you want to use the price specified in the cost field');
...
define('MODULE_SHIPPING_NWPOCHTA_SHIPPING_PRICE_TEXT_TITLE', 'Delivery price text');
define('MODULE_SHIPPING_NWPOCHTA_SHIPPING_PRICE_TEXT_DESC', 'Leave blank if you want to use the price specified in the cost field');
define('MODULE_SHIPPING_NWPOSHTANEW_COST_DESC', 'The cost of using this shipping method.');
define('MODULE_SHIPPING_NWPOSHTANEW_TAX_CLASS_TITLE', 'Tax');
define('MODULE_SHIPPING_NWPOSHTANEW_TAX_CLASS_DESC', 'Use tax.');
define('MODULE_SHIPPING_NWPOSHTANEW_ZONE_TITLE', 'Zone');
define('MODULE_SHIPPING_NWPOSHTANEW_ZONE_DESC', 'If a zone is selected, this shipping module will only be visible to customers in the selected zone.');
define('MODULE_SHIPPING_NWPOSHTANEW_SORT_ORDER_TITLE', 'Sort Order');
define('MODULE_SHIPPING_NWPOSHTANEW_SORT_ORDER_DESC', 'Module sort order.');
define('MODULE_SHIPPING_NWPOSHTANEW_API_KEY_TITLE', 'API Key');
define('MODULE_SHIPPING_NWPOSHTANEW_API_KEY_DESCRIPTION', 'May be required to update warehouses');
define('MODULE_SHIPPING_NWPOSHTANEW_SHOW_SHIPPING_COST_STATUS_TITLE', 'Show shipping cost');
...
define('MODULE_SHIPPING_PERCENT_RATE_DESC', 'The cost of delivery of this module is a percentage of the total value of the order, values from .01 to .99');
define('MODULE_SHIPPING_PERCENT_LESS_THEN_TITLE', 'Flat cost for orders up to');
define('MODULE_SHIPPING_PERCENT_LESS_THEN_DESC', 'Flat shipping cost for orders, cost up to the specified value.');
define('MODULE_SHIPPING_PERCENT_FLAT_USE_TITLE', 'Flat percentage cost');
define('MODULE_SHIPPING_PERCENT_FLAT_USE_DESC', 'Flat shipping costs as a percentage of the total order value, valid for all orders.');
...
define('MODULE_SHIPPING_ZONES_COUNTRIES_1_TITLE', 'Countries for zone 1');
define('MODULE_SHIPPING_ZONES_COUNTRIES_1_DESC', 'Comma separated countries list for zone 1.');
define('MODULE_SHIPPING_ZONES_COST_1_TITLE', 'Shipping cost for zone 1');
define('MODULE_SHIPPING_ZONES_COST_1_DESC', 'Delivery cost is comma separated for zone 1 based on the maximum cost of the order. For example: 3: 8.50,7: 10.50, ... This means that the shipping cost for orders, weighing up to 3 kg will cost 8.50 for buyers from the countries of the 1st zone.');
define('MODULE_SHIPPING_ZONES_HANDLING_1_TITLE', 'Cost for zone 1');
define('MODULE_SHIPPING_ZONES_HANDLING_1_DESC', 'The cost of using this method of delivery.');
...
define('SHIPPING_TAB_TITLE', 'Shipping');
define('SHIPPING_TO_PAYMENT_TAB_TITLE', 'Ship To Pay');
define('SHIPPING_TO_FIELDS_TAB_TITLE', 'Ship To Fields');
define('SHIPPING_UPDATE_WAREHOUSES_TITLE', 'Update warehouses');
