...
define('DAILY_TOTAL','total/day');
define('AVERAGE_TOTAL','average order total');
...
define('TEXT_AVERAGE_ORDER','Average orders total');
define('TEXT_TOTAL_SUMM','Total orders sum');

define('TEXT_STATS_SALES',' sales statistics');

define('TAB_CHART','Chart');
define('TAB_TABLE','Table');
define('TAB_STATUS','Order statuses');
