...
define('TEXT_EXIST_CUSTOMER', 'Existe cliente');
...
define('ENTRY_NOTIFY_CUSTOMER_EMAIL', 'Notificar al cliente por correo electrónico? ');
...
define('TEXT_CURRENCY', 'Divisa:');
define('TEXT_CURRENCY_VALUE', 'Calificar');

define('ENTRY_BILLING', 'Facturación:');
