...
define('TEXT_INFO_DELETE_FILE_INTRO', 'Remove <span><b>%s</b></span> from <b>%s</b> box? ');
define('TEXT_INFO_NEW_FILE_INTRO', 'Check the <span><b>left menu</b></span> to make sure you store the right files.');
...
define('BUTTON_ADMIN_FILES_NEW', 'almacenar archivos');
define('BUTTON_ADMIN_REMOVE_NEW', 'retirar');
