...
define('TABLE_HEADING_ORDER_STATUS_TEXT','Texto de estado del pedido');
define('TABLE_HEADING_DEFAULT', 'Default');
define('TABLE_HEADING_ACTION', 'Action');
define('TABLE_HEADING_COLOR', 'Color');
define ('TABLE_HEADING_STATUS_SHOW', 'Mostrar en la página de inicio del administrador');
...
define('ERROR_ORDER_STATUS_IS_DEFAULT', 'No puede eliminar el estado de pedido predeterminado');
define('TABLE_HEADING_DOWNLOADS', 'Permitir descargar artículos electrónicos');