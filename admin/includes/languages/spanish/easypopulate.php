...
define('EASY_R_STATUS_DELETE', 'borrar');
...
define('EASY_R_FILTER', 'Filtración');
define('EASY_LABEL_ALGORITHM', 'Importar algoritmo');
define('EASY_LABEL_DELIMITER', 'Delimitador');
define('EASY_SELECT_FILE', 'Seleccione un archivo');
define('EASY_EXPORT_DATA', 'Exportar datos');
define('EASY_LABEL_EXPORT_FULL_ATTR_INF', 'Descargar información completa de atributos');
define('EASY_LABEL_IMPORT_FULL_ATTR_INF', 'Descargar información completa de atributos');
