...
define('TEXT_ARTICLES_LINK', 'Enlace URL personalizado');
...
define('TEXT_SHOW_IN_SITEMAP', 'Mostrar en mapa del sitio');
...
define('TEXT_COPY_AS_MOVE', 'Mover');
...
define('HEADING_TITLE_NAME', 'Título');
define('TEXT_ALL', 'Todo');
define('TOPICS_SEO_URL_TITLE', 'Topic SEO URL');
define('TEXT_ARTICLES_IMAGE_MOBILE','Imagen móvil');
