...
define('TEXT_PROD_LOAD_FILES','Cargar archivos:');
define('TEXT_ALOWED_FILE_TYPES','Tipos de archivos permitidos:');
define('TEXT_PROD_FILES_DRAG','Arrastra los archivos aquí');
define('TEXT_PROD_DOWNLOADS','Archivos para descargar');
define('TEXT_IS_DOWNLOAD_PRODUCT','Producto electrónico:');
...
define('TEXT_XSELLS_ADD', 'Add xsell by products Model:');
define('TEXT_XSELLS_ADD_BUTTON', 'Add');
define('TEXT_XSELLS_DEL_BUTTON', 'Delete');

define('TEXT_QTY_PRO_QUANTITY_LABEL', 'Cantidad');
define('TEXT_QTY_PRO_COMBINATION_PRICE_LABEL', 'Precio');
define('TEXT_QTY_PRO_VENDOR_CODE_LABEL', 'Código de proveedor');
...
define('TEXT_EMPTY_ATTRIBUTES', 'Primero, agregue un atributo al producto con al menos dos valores.');
...
define('TEXT_PROD_TEXTS','Texts');
define('TEXT_PROD_IMGS','Images');
define('TEXT_PROD_VIDEO','Video');
define('TEXT_PROD_ATTRS','Attributes');
define('TEXT_PROD_LINK','Link');
define('TEXT_PROD_PRICE','Price');
define('TEXT_PROD_TOP','TOP');
define('TEXT_PROD_NEW','NEW');
define('TEXT_PROD_AKC','PROMO');
define('TEXT_PROD_WE','Weight');
define('TEXT_PROD_SORT','Sort order');
define('TEXT_PROD_QTY','Qty');
define('TEXT_PROD_MINORD','Minimum order qty');
define('TEXT_PROD_IMGS2','Product images');
define('TEXT_PROD_IMGS3','x');
define('TEXT_PROD_IMGS_OR','or');
define('TEXT_PROD_IMGS_DRAG','Drag images here');
define('TEXT_PROD_COLOR','Color');
define('TEXT_PROD_CROP','Crop');
define('TEXT_PROD_SAVE_BEFORE','Save product before adding images.');
define('TEXT_PROD_LOAD_IMGS','Upload images');
define('TEXT_PROD_LOAD_IMGS_BUT','Upload');
...
define('BUTTON_QUICK_VIEW', 'Vista rápida');

define('TEXT_EDITED_FOR_SEO', 'Editado para SEO');
define('TEXT_LINK_TO_YOUTUBE', 'Enlace al video de Youtube');
define('TEXT_IMAGE_PREVIEW', 'Vista previa');
define('TEXT_CHOOSE_ON_SERVER', 'elegir en el servidor');