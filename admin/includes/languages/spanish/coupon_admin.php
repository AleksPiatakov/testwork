...
define('HEADING_TITLE', 'Discount Promo codes');
define('HEADING_TITLE_STATUS', 'Status : ');
define('TEXT_CUSTOMER', 'Customer:');
define('TEXT_COUPON', 'Coupon Name');
define('TEXT_COUPON_ALL', 'All Promo codes');
define('TEXT_COUPON_ACTIVE', 'Active Promo codes');
define('TEXT_COUPON_INACTIVE', 'Inactive Promo codes');
...
define('COUPON_FOR_EVERY_PRODUCT', 'Utilizar para cada producto adecuado');
...
define('COUPON_FOR_EVERY_PRODUCT_HELP', 'El cupón de descuento se aplicará a todos los artículos elegibles del carrito. La opción funciona solo si hay una restricción en el producto o la categoría.');
...
define('TEXT_TOOLTIP_VOUCHER_EMAIL', 'Email voucher');
define('TEXT_TOOLTIP_VOUCHER_EDIT', 'Edit voucher');
define('TEXT_TOOLTIP_VOUCHER_DELETE', 'Delete voucher');
define('TEXT_TOOLTIP_VOUCHER_REPORT', 'Voucher report');
