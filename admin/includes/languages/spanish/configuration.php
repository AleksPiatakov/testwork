...
define('TABLE_HEADING_CONFIGURATION_SHOW_FIELD', 'Mostrar campo');
define('TABLE_HEADING_CONFIGURATION_REQUIRED_VALUE', 'Obligatorio');
...
define('SEO_ADD_PARENT_CATEGORIES_TO_URL_TITLE', '¿Agregar ID de categorías principales a la URL?');
...
define('SEO_FILTER_TITLE' , 'Habilitar filtros de SEO');
define('ONEPAGE_ADDRESS_TYPE_POSITION_TITLE' , 'Orden de dirección');
define('GOOGLE_SITE_VERIFICATION_KEY_TITLE', 'Google site verification key');
define('REVIEWS_WRITE_ACCESS_TITLE' , 'Permitir que solo los usuarios registrados escriban reseñas');

// Мой магазин
define ('USE_CRITICAL_CSS_TITLE', '¿Usar CSS crítico?');
define('MYSQL_PERFORMANCE_TRESHOLD_TITLE' , 'MySQL Performance Log time "from"');
define('MINIFY_CSSJS_TITLE' , 'Reducir CSS y JS?');
define('MENU_LOCATION_TITLE' , 'Ubicación del menú del administrador: ');
define('MENU_TOP_LOCATION' , 'desde arriba');
define('MENU_LEFT_LOCATION' , 'a la izquierda');
define('MENU_LEFT_MIN_LOCATION' , 'izquierda y doblada');
define('MINIFY_CSSJS_0_TITLE' , 'No minificar');
define('MINIFY_CSSJS_1_TITLE' , 'Minimizar ahora');
define('MINIFY_CSSJS_2_TITLE' , 'Usar archivo minificado');
define('SEO_URLS_CACHE_RESET_TITLE', 'Reset cache for SEO URLs');
define('IMAGE_CACHE_TITLE', 'Editar IMAGE_CACHE');
define('IMAGE_CACHE_0_TITLE', 'Apagar');
define('IMAGE_CACHE_1_TITLE', 'Habilitar');
...
define('STORE_ADDRESS_TITLE' , 'Dirección de la tienda');
...
define('ENABLE_DEBUG_PAGE_SPEED_TITLE', 'Habilitar la depuración de carga de la página');
define('SET_WWW_TITLE' , 'Redirigir a www');
define('WWW_TOO_MANY_REDIRECTS' , 'Demasiados redireccionamientos, sin cambios');
...
define('ENTRY_SUBURB_MIN_LENGTH_TITLE', 'Suburbio');
...
define('SLIDER_HEIGHT_TITLE' , 'altura del deslizador');
...
define('ACCOUNT_FIRST_NAME_TITLE' , 'Nombre');
...
define('STOCK_SHOW_BUY_BUTTON_TITLE' , 'Mostrar el botón Comprar si falta el artículo');
define('STOCK_LIMITED_TITLE', 'Subtract stock');
define('STOCK_ALLOW_CHECKOUT_TITLE', 'Allow Checkout');
define('STOCK_DISABLE_NON_EXISTENT_PRODUCT_ON_CHECKOUT_TITLE', 'Deshabilitar productos canjeados');
...
define('SEND_EXTRA_ORDER_EMAILS_TO_DESC', 'Send order emails to the following email addresses, in this format: Name 1 &lt;email@address1&gt;, Name 2 &lt;email@address2&gt;');
...
define('STOCK_DISABLE_NON_EXISTENT_PRODUCT_ON_CHECKOUT_DESC', 'Deshabilitar productos con cantidad 0 después de la compra');
...
define('GOOGLE_ANALYTICS_AND_TAGS_MODULE_ENABLED_TITLE', 'Habilitar de etiquetas y Google Analytics');
...
define('GOOGLE_GOALS_PAGE_VIEW_TITLE', 'El objetivo \'page_view\' es ver cada página');
define('GOOGLE_GOALS_ADD_TO_CART_TITLE', 'Target \'add_to_cart\' es cuando un cliente agrega un artículo al carrito');
define('GOOGLE_GOALS_ON_CHECKOUT_TITLE', 'Target \'checkout_view\' is to view the checkout page');
define('GOOGLE_GOALS_CHECKOUT_PROCESS_TITLE', 'Objetivo \'checkout_progress\' - el cliente ha realizado un pedido con éxito');
define('GOOGLE_GOALS_CHECKOUT_SUCCESS_TITLE', 'El objetivo de \'checkout_success\' es ver la página después de la confirmación del pedido');
define('GOOGLE_GOALS_CLICK_FAST_BUY_TITLE', 'Target \'fast_buy\' - cuando un cliente hace clic en el botón "Pedido rápido" en la página del producto');
define('GOOGLE_GOALS_LOGIN_TITLE', 'Target \'login\' es cuando el cliente inicia sesión');
define('GOOGLE_GOALS_ADD_REVIEW_TITLE', 'Target \'add_review\' es cuando un cliente agrega una reseña');
define('GOOGLE_GOALS_FILTER_TITLE', 'El objetivo de \'filtro\' es cuando un cliente usa un filtro para buscar productos');
define('GOOGLE_GOALS_CALLBACK_TITLE', 'Target \'callback\' - cuando el cliente hace clic en el botón \'Callback\' en el encabezado del sitio');
define('GOOGLE_GOALS_CLICK_ON_PHONE_TITLE', 'Target \'phone_call\' es cuando el cliente hace clic en el icono del teléfono');
define('GOOGLE_GOALS_CLICK_ON_CHAT_TITLE', 'Target \'click_chat\' es cuando el cliente hace clic en el chat');
define('GOOGLE_GOALS_CONTACT_US_TITLE', 'Target \'contact_us\' - cuando el cliente hizo una solicitud en la página de contacto');
define('GOOGLE_GOALS_SUBSCRIBE_TITLE', 'Target \'subscribe\' - cuando el cliente se suscribió');
define('GOOGLE_GOALS_CLICK_ON_BUG_REPORT_TITLE', 'El objetivo de \'bug_report\' es cuando el cliente hace clic en \'Enviar informe de error\' en el pie de página del sitio');

define('GOOGLE_ECOMM_SUCCESS_PAGE_TITLE', 'Compra de comercio electrónico \'compra\' - vista de página después de la confirmación del pedido');
define('GOOGLE_ECOMM_CHECKOUT_PAGE_TITLE', 'Objetivo de comercio electrónico \'carrito\' - Página de pago');
define('GOOGLE_ECOMM_PRODUCT_DETAIL_PAGE_TITLE', 'El objetivo de comercio electrónico del \'producto\' es ver la página del producto');
define('GOOGLE_ECOMM_SEARCH_RESULTS_TITLE', 'Objetivo de comercio electrónico \'resultados de búsqueda\' - ver página de resultados de búsqueda');
define('GOOGLE_ECOMM_HOME_PAGE_TITLE', 'El objetivo de comercio electrónico \'home\' es ver la página del producto');
...
define('FACEBOOK_AUTH_STATUS_TITLE', 'Facebook Autorización');

define ('RCS_BASE_DAYS_TITLE', 'Mirar días atrás');
define ('RCS_SKIP_DAYS_TITLE', 'Omitir días');
define ('RCS_REPORT_DAYS_TITLE', 'Usar impuestos calculados');
define ('RCS_INCLUDE_TAX_IN_PRICES_TITLE', 'Usar tasa impositiva fija');
define ('RCS_USE_FIXED_TAX_IN_PRICES_TITLE', 'Tasa de impuesto fija');
define ('RCS_FIXED_TAX_RATE_TITLE', 'Días de informe de resultados de ventas');
define ('RCS_EMAIL_TTL_TITLE', 'Correo electrónico tiempo de vida');
define ('RCS_EMAIL_FRIENDLY_TITLE', 'Correos electrónicos amigables');
define ('RCS_EMAIL_COPIES_TO_TITLE', 'Copias de correo electrónico a');
define ('RCS_SHOW_ATTRIBUTES_TITLE', 'Mostrar atributos');
define ('RCS_CHECK_SESSIONS_TITLE', 'Ignorar clientes con sesiones');
define ('RCS_CURCUST_COLOR_TITLE', 'Cliente actual');
define ('RCS_UNCONTACTED_COLOR_TITLE', 'Hilux sin contacto');
define ('RCS_CONTACTED_COLOR_TITLE', "Contactado Hilight");
define ('RCS_MATCHED_ORDER_COLOR_TITLE', "Orden de coincidencia Hilight");
define ('RCS_SKIP_MATCHED_CARTS_TITLE', 'Saltar entradas con órdenes coincidentes');
define ("RCS_AUTO_CHECK_TITLE", 'Verificación automática de carritos "seguros" para enviar por correo electrónico');
define ('RCS_CARTS_MATCH_ALL_DATES_TITLE', 'Hacer coincidir pedidos desde cualquier fecha');
define ('RCS_PENDING_SALE_STATUS_TITLE', 'Estados de ventas pendientes');
define ('RCS_REPORT_EVEN_STYLE_TITLE', 'Informar estilo de fila par');
define ('RCS_REPORT_ODD_STYLE_TITLE', 'Informar estilo de fila impar');

define ('DEFAULT_DATE_FORMAT_TITLE', "Título del formato de fecha predeterminado");
define ('DEFAULT_FORMATED_DATE_FORMAT_TITLE', "Título de formato de fecha con formato predeterminado");

define('DISPLAY_PRICE_WITH_TAX_CHECKOUT_TITLE', 'Calcule el impuesto al hacer un pedido');

define('SET_JIVOSITE_TITLE', 'Habilitar o deshabilitar JivoSite');
define('INSTAGRAM_LINK_SLIDE_TITLE', 'Diapositiva de enlace de Instagram');


define('STORE_BANK_INFO_TITLE', 'Información bancaria para factura');
define('STORE_TIME_ZONE_TITLE', 'Zona horaria');
define('JIVOSITE_WIDGET_ID_TITLE', 'ID del widget de JivoSite');
define('STORE_SCRIPTS_TITLE' , 'Incluyendo JS personalizado');
define('STORE_METAS_TITLE' , 'Incluyendo metaetiquetas personalizadas en la head');
define('CHANGE_BY_GEOLOCATION_TITLE', 'Cambio de moneda e idioma según la geolocalización');
define('GET_BROWSER_LANGUAGE_TITLE', 'Cambiar el sitio al idioma del navegador');
define('DOMEN_URL_TITLE', 'Dirección del domo');
define('DOMEN_URL_DESC', 'Puedes establecer tu propio nombre de dominio');
define('STOCK_ALLOW_CHECKOUT_WITH_ATTR_COUNT_0_TITLE', 'Permitir comprar con 0 en los atributos del producto');
define('STOCK_ALLOW_CHECKOUT_WITH_ATTR_COUNT_0_DESC', 'Permitir comprar cuando la cantidad es 0 en los atributos del producto');
define('SSL_EXIST', 'Certificado emitido');
define('SSL_NON_EXIST', 'Emitir certificado');
define('SSL_ARE_YOU_SURE', 'Esto comenzará a generar un certificado SSL personal para el dominio. ¿Estás seguro?');
define('QUICK_ORDER_ENABLED_TITLE' , 'Botón de pedido rápido');