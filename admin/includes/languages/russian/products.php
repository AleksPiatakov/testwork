...
*/
define('TEXT_PROD_LOAD_FILES','Загрузите файлы:');
define('TEXT_ALOWED_FILE_TYPES','Разрешенные типы файлов:');
define('TEXT_PROD_FILES_DRAG','Перетащите файлы сюда');
define('TEXT_PROD_DOWNLOADS','Файлы для загрузки');
define('TEXT_IS_DOWNLOAD_PRODUCT','Электронный товар:');
...
define('TEXT_EMPTY_ATTRIBUTES', 'Сначала добавьте товару атрибут как минимум с двумя значениями.');
...
define('TEXT_LINK_TO_YOUTUBE', 'Ссылка на Youtube видео');
define('TEXT_IMAGE_PREVIEW', 'Превью');
define('TEXT_CHOOSE_ON_SERVER', 'Выбрать на сервере');