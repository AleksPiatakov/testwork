...
define('SHOW_ALL_LABELS_ON_DESKTOP', 'Показывать все лейблы на десктопе');
define('SHOW_ALL_LABELS_ON_MOBILE', 'Показывать все лейблы на мобильном устройстве');
define('SHOW_SPECIAL_LABEL_WITH_SPECIAL', 'Показывать лейблу скидки, если есть скидка');
...
define('F_WEB_STUDIO_LINK', 'Ссылка на поставщика услуги');
define('TEXT_UNAVAILABLE_IN_FREE_PACKAGE', 'Недоступно в пакете free');
...
define('M_SUBSCRIBE', 'Подписка на новую рассылку');
define('M_SUBSCRIBE_SPECIAL', 'Скидка за подписку');
define('M_SUBSCRIBE_SPECIAL_PERCENT', 'Процент скидки %');
define('M_SUBSCRIBE_COUPONE_MAIL', 'Отправлять купон');
...
/*Подсказки страницы - Дизайн*/
define('MAX_DISPLAY_SEARCH_RESULTS_TITLE_INFO', 'Укажите нужное количество товаров на странице');
define('MAX_DISPLAY_SEARCH_RESULTS_TITLE_INFO_DEL', 'Удалить значение');
define('MAX_DISPLAY_SEARCH_RESULTS_TITLE_INFO_ADD', 'Добавить значение');

define('CONTENT_WIDTH_INFO', 'Выберите ширину контента из предложеных вариантов');
define('MC_PRODUCT_QNT_IN_ROW_INFO', 'Укажите нужное количество товаров в строке');

define('MC_PRODUCT_QNT_IN_ROW_INFO_0', 'Телефон < 768px. Значение \'3\' приравнивается к \'2\', если ≤ 480px ');
...
define('MC_THUMB_HEIGHT_INFO', 'Укажите высоту маленького изображения');
define('MC_THUMB_WIDTH_INFO', 'Укажите ширину маленького изображения');
define('MC_SHOW_LEFT_COLUMN_INFO', 'Можно включить/выключить вывод левой колонки контента');
define('MC_LOGO_WIDTH_INFO', 'Укажите ширину логотипа Вашего сайта');
define('MC_LOGO_HEIGHT_INFO', 'Укажите высоту логотипа Вашего сайта');
define('MC_PRODUCT_MARGIN_INFO', 'Можете указать нужный отступ между товарами');
define('LIST_DISPLAY_TYPE_INFO', 'Можете указать формат вывода товара: list - списком, columns - таблицей');
define('MC_THUMB_FIT_INFO', 'Выберите нужное значение: contain - сохранение пропорций картинки, cover-масштабирует изображение на весь блок ');
define('MC_SHOW_THUMB2_INFO', 'Можете всключить/выключить эфект смены одной картинки на другую при наведении на неё курсора');
define('MC_COLOR_1_INFO', 'Нажмите на палитру для изменения цвета текста для Вашего сайта');
define('MC_COLOR_4_INFO', 'Нажмите на палитру для изменения фона шапки сайта');
define('MC_COLOR_5_INFO', 'Нажмите на палитру для изменения фона подвала');
define('MC_COLOR_2_INFO', 'Нажмите на палитру для изменения цвета ссылок Вашего сайта');
define('MC_COLOR_6_INFO', 'Нажмите на палитру для изменения цвета кнопок сайта');
define('MC_COLOR_3_INFO', 'Нажмите на палитру для изменения цвета фона Вашего сайта');
define('MC_COLOR_BTN_TEXT_INFO', 'Нажмите на палитру для изменения цвета текста для кнопок');
define('MC_COLOR_GREY_INFO', 'Нажмите на палитру для изменения цвета серых элементов');
/*//Подсказки страницы - Дизайн*/

define('MC_THUMB_WIDTH', 'Ширина маленького изображения');
define('MC_THUMB_HEIGHT', 'Высота маленького изображения');
define('H_LOGO_WIDTH', 'Ширина логотипа');
define('H_LOGO_HEIGHT', 'Высота логотипа');
define('H_LOGO_WIDTH_MOBILE', 'Ширина логотипа (mobile)');
define('H_LOGO_HEIGHT_MOBILE', 'Высота логотипа (mobile)');
...
define('LIST_LABELS', 'Показывать лейблы');
...
define('SHOW_SHORTCUT_LEFT_TREE', 'Показать свернутое левое дерево');
define('F_FOOTER_CATEGORIES', 'Категории в футере');
define('P_SHOW_PROD_QTY_ON_PAGE', 'Показывать остаток товара на складе');
define('P_LABELS', 'Показывать лейблы');
