...
define('ENTRY_SEARCH_CLIENT', 'Поиск по имени, фамилии или id клиента.');
...
define('ENTRY_BILLING_ADDRESS', 'Адрес оплаты');
...
define('ENTRY_NEW_TOTAL', 'Добавить поле:');
...
define('TEXT_PRODUCT_NAME_PLACEHOLDER', 'Введите название товара');
