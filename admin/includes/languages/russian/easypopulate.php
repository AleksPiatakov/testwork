...
define('EASY_LABEL_EXPORT_FULL_ATTR_INF', 'Выгружать полную информацию об атрибутах');
define('EASY_LABEL_IMPORT_FULL_ATTR_INF', 'Загружать полную информацию об атрибутах');
