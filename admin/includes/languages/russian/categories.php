...
define('TEXT_ID_XML_CATEGORY','ID XML категории');
define('TEXT_VENDOR_XML_CATEGORY','Vendor XML категории');
define('ERROR_SYS_CATEGORY_EXIST','ID XML категории %s уже занят <a href="'.DIR_WS_ADMIN . 'categories.php?cID=%s&action=edit_category" target="_blank">другой категорией</a>');
?>