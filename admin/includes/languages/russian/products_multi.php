...
define('HEADING_TITLE', 'Массовое управление товарами');
...
define('TEXT_NO_CHILD_CATEGORIES_OR_PRODUCTS', 'Пожалуйста, вставьте новую категорию или товар в <br>&nbsp;<br><b>%s</b>');
...
define('TEXT_PMU_CANCEL', 'отметить');
define('TEXT_DUBLICATE_TO', 'Дублировать в');
define('TEXT_PMU_LINK', 'Ссылкой в');
define('TEXT_PMU_DEL', 'удалить');
define('TEXT_PMU_DUBL_CATEGORY', 'Дублировать каталог:');

//Button
define('BUTTON_BACK_NEW', 'назад');
define('BUTTON_PMU_SUBMIT', 'Выполнить');