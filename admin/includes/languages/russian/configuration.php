...
define('TABLE_HEADING_CONFIGURATION_SHOW_FIELD', 'Показывать поле');
define('TABLE_HEADING_CONFIGURATION_REQUIRED_VALUE', 'Обязательность');
...
define('ENTRY_COUNTRY_MIN_LENGTH_TITLE', 'Страна');
...
define('ACCOUNT_FIRST_NAME_TITLE' , 'Имя');
...
define('STOCK_DISABLE_NON_EXISTENT_PRODUCT_ON_CHECKOUT_TITLE', 'Отключать выкупленные товары');
...
define('STOCK_DISABLE_NON_EXISTENT_PRODUCT_ON_CHECKOUT_DESC', 'Отключать товары с количеством 0 после покупки');
...
define('GOOGLE_OAUTH_STATUS_TITLE', 'Включить Google Authorization');
...
define('GOOGLE_ANALYTICS_AND_TAGS_MODULE_ENABLED_TITLE', 'Включить Google Analytics');
define('GOOGLE_TAGS_ID_STATUS_TITLE', 'Google Tags ID status');

define('GOOGLE_GOALS_PAGE_VIEW_TITLE', 'Цель \'page_view\' - просмотр каждой страницы');
define('GOOGLE_GOALS_ADD_TO_CART_TITLE', 'Цель \'add_to_cart\' - когда клиент добавляет товар в корзину');
define('GOOGLE_GOALS_ON_CHECKOUT_TITLE', 'Цель \'checkout_view\' - просмотр страницы оформления заказа');
define('GOOGLE_GOALS_CHECKOUT_PROCESS_TITLE', 'Цель \'checkout_progress\' - клиент успешно оформил заказ');
define('GOOGLE_GOALS_CHECKOUT_SUCCESS_TITLE', 'Цель \'checkout_success\' - просмотр страницы после подтверждения заказа');
define('GOOGLE_GOALS_CLICK_FAST_BUY_TITLE', 'Цель \'fast_buy\' - когда клиент нажимает кнопку «Быстрый заказ» на странице товара');
define('GOOGLE_GOALS_LOGIN_TITLE', 'Цель \'login\' - когда клиент вошел в систему');
define('GOOGLE_GOALS_ADD_REVIEW_TITLE', 'Цель \'add_review\' - когда клиент добавил отзыв');
define('GOOGLE_GOALS_FILTER_TITLE', 'Цель \'filter\' - когда клиент использует фильтр для поиска товаров');
define('GOOGLE_GOALS_CALLBACK_TITLE', 'Цель \'callback\' - когда клиент нажимает кнопку \'Обратный звонок\' в шапке сайта');
define('GOOGLE_GOALS_CLICK_ON_PHONE_TITLE', 'Цель \'phone_call\' - когда клиент нажимает на иконку телефона');
define('GOOGLE_GOALS_CLICK_ON_CHAT_TITLE', 'Цель \'click_chat\' - когда клиент нажимает на чат');
define('GOOGLE_GOALS_CONTACT_US_TITLE', 'Цель \'contact_us\' - когда клиент создал запрос на странице контактов');
define('GOOGLE_GOALS_SUBSCRIBE_TITLE', 'Цель \'subscribe\' - когда клиент подписался');
define('GOOGLE_GOALS_CLICK_ON_BUG_REPORT_TITLE', 'Цель \'bug_report\' - когда клиент нажимает \'Отправить сообщение об ошибке\' в нижнем колонтитуле сайта');

define('GOOGLE_ECOMM_SUCCESS_PAGE_TITLE', 'Цель электронной торговли \'purchase\' - просмотр страницы  после подтверждения заказа');
define('GOOGLE_ECOMM_CHECKOUT_PAGE_TITLE', 'Цель электронной торговли \'cart\' - страница оформления заказа');
define('GOOGLE_ECOMM_PRODUCT_DETAIL_PAGE_TITLE', 'Цель электронной торговли \'product\' - просмотр страницы продукта');
define('GOOGLE_ECOMM_SEARCH_RESULTS_TITLE', 'Цель электронной торговли \'searchresults\'- просмотр страницы  результатов поиска');
define('GOOGLE_ECOMM_HOME_PAGE_TITLE', 'Цель электронной торговли \'home\' - просмотр страницы продукта');
define('GOOGLE_ECOMM_CLICK_FAST_BUY_TITLE', 'Цель электронной торговли \'Purchase\' - когда клиент подтверждает \'Quick order\' на странице товара');
...
define('STORE_TIME_ZONE_TITLE', 'Часовой пояс');
define('CHANGE_BY_GEOLOCATION_TITLE', 'Переключение валюты и языка в зависимости от геолокации');
define('GET_BROWSER_LANGUAGE_TITLE', 'Переключать сайт на язык браузера');

define('SUB_GROUP_TAXES', 'Taxes');

define('JIVOSITE_WIDGET_ID_TITLE', 'ID виджета JivoSite');

define('DOMEN_URL_TITLE', 'Адрес домена');
define('DOMEN_URL_DESC', 'Вы можете задать имя собственного домена');
define('STOCK_ALLOW_CHECKOUT_WITH_ATTR_COUNT_0_TITLE', 'Разрешить покупать при 0 в атрибутах товара');
define('STOCK_ALLOW_CHECKOUT_WITH_ATTR_COUNT_0_DESC', 'Разрешить покупать при количестве 0 в атрибутах товара');
define('SSL_EXIST', 'Сертификат выпущен');
define('SSL_NON_EXIST', 'Выпустить сертификат');
define('SSL_ARE_YOU_SURE', 'Это запустит процедуру генерации персонального сертификата SSL для домена. Вы уверены?');
define('QUICK_ORDER_ENABLED_TITLE' , 'Кнопка быстрого заказа');