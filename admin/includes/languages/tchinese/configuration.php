...
define('SEO_ADD_PARENT_CATEGORIES_TO_URL_TITLE', '将父类别 ID 添加到 URL？');
...
define('SEND_EXTRA_ORDER_EMAILS_TO_TITLE', 'Send order Emails To');
...
define('ENABLE_DEBUG_PAGE_SPEED_TITLE', '啟用頁面加載調試');
...
define('ENTRY_FAX_MIN_LENGTH_TITLE', '传真');
define('ENTRY_SUBURB_MIN_LENGTH_TITLE', '市郊');
...
define('DEFAULT_FORMATED_DATE_FORMAT_TITLE', "Default formated date format title");
...
define('STORE_TIME_ZONE_TITLE', '时区');
...
define('QUICK_ORDER_ENABLED_TITLE', '快速订购按钮');
