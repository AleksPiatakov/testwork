...
define('ENTRY_SEARCH_CLIENT', 'Search by first name, last name or client id.');
...
define('EMAIL_SEPARATOR', '<br /><br />------------------------------------------------------');
define('EMAIL_TEXT_SUBJECT', '您的訂單訊息已更新');
define('EMAIL_TEXT_ORDER_NUMBER', '<br>訂單編號：');
define('EMAIL_TEXT_INVOICE_URL', '<br>訂單詳細內容網址:');
define('EMAIL_TEXT_DATE_ORDERED', '<br>訂單日期：');
define('EMAIL_TEXT_STATUS_UPDATE', '<br /><br />我們很感謝您對我們的支持與愛護。<br /><br />您的訂單狀態有更新的訊息，請查看一下喔～<br /><br /><br />訊息如下： %s　<br />');
...
define('EMAIL_TEXT_COMMENTS_UPDATE', '<br>%s<br><br>');
...
define('TEXT_PRODUCT_NAME_PLACEHOLDER', 'Enter product name');
