...
define('TEXT_SALEMAKER_MANUFACTURERS', '<b>Или</b> выберите производителей, для которых будет действительна данная акция:');
...
define('BUTTON_SALE_NEW', 'продажа');
define('BUTTON_COPY_TO_NEW', 'скопировать в');
?>