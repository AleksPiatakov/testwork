...
define('TEXT_INFO_DELETE_FILE_INTRO', 'Вы действительно хотите удалить файл <span><b>%s</b></span> из бокса <b>%s</b>? ');
define('TEXT_INFO_NEW_FILE_INTRO', 'Убедитесь, что файл, который Вы хотите добавить отсутствует в <span><b>списке файлов</b></span> слева. Возможно, файл, который Вы хотите добавить, уже есть в списке.');

define('TEXT_INFO_NEW_FILE_BOX', 'Текущий бокс: ');

//Button
define('BUTTON_CANCEL_NEW', 'отмена');
define('BUTTON_BACK_NEW', 'назад');
define('BUTTON_ADMIN_FILES_NEW', 'добавить файлы');
define('BUTTON_ADMIN_REMOVE_NEW', 'удалить');
?>
