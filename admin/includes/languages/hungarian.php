...
define('HEADER_GO_TO_SITE', 'Ugrás az oldalra');
...
define('BOX_CATALOG_STATS_SEARCH_KEYWORDS', "Kulcsszavak tervezője");
...
define('TOOLTIP_STORE_OWNER', 'Adja meg az üzlet tulajdonosát');
define('TOOLTIP_SHOW_BASKET_ON_ADD_TO_CART', 'Engedélyezve a kosár termék hozzáadásakor elérhető lesz, hogy a látogatónak ne legyen kérdése, hogy a terméket a kosárba helyezték.');
define('TOOLTIP_USE_DEFAULT_LANGUAGE_CURRENCY', 'Engedélyezze a pénznem automatikus módosítását a webhely aktuális nyelvének megfelelően.');
define('TOOLTIP_CHANGE_BY_GEOLOCATION', 'Engedélyezze a webhely pénznemének és nyelvének a földrajzi hely alapján történő módosítását.');
define('TOOLTIP_GET_BROWSER_LANGUAGE', 'Engedélyezze a webhely pénznemének módosítását a böngésző nyelvétől függően.');
define('TOOLTIP_STORE_BANK_INFO', 'Lehetővé teszi a pontos banki adatok megadását a számla részleteihez');
define('TOOLTIP_ONEPAGE_LOGIN_REQUIRED', 'Engedélyezés és felhasználói/kliens bejelentkezés mindig szükséges lesz');
define('TOOLTIP_REVIEWS_WRITE_ACCESS', 'Engedélyezze, és csak a regisztrált felhasználók írhatnak megjegyzéseket');
define('TOOLTIP_ROBOTS_TXT', 'A teljes webhely vagy egyes szakaszainak védelme az indexeléstől');
define('TOOLTIP_MENU_LOCATION', 'Menüpont kiválasztása: fent, balra vagy balra összecsukva');
define('TOOLTIP_DEFAULT_DATE_FORMAT', 'Válassza ki a dátumformátumot');
define('TOOLTIP_SET_HTTPS', 'Engedélyezze a HTTPS protokollbővítményt, hogy támogassa a titkosítást a nagyobb biztonság érdekében');
define('TOOLTIP_SET_WWW', 'Válassza ki az átirányítás beállítását: letilt, www->no-www vagy no-www->www');
define('TOOLTIP_ENABLE_DEBUG_PAGE_SPEED', 'Az oldalbetöltési hibakeresés engedélyezése a szkript hibáinak megtalálásához és kijavításához');
define('TOOLTIP_STORE_SCRIPTS', 'További JS-parancsfájlokat is megadhat');
define('TOOLTIP_STORE_METAS', 'További metacímkéket is beilleszthet a fejlécbe');
define('TOOLTIP_MYSQL_PERFORMANCE_TRESHOLD', 'Állítsa be "másodpercben" azt az időt, amely felett a lassú és potenciálisan problémás lekérdezések naplózásra kerülnek az adatbázisba');
define('TOOLTIP_STOCK_REORDER_LEVEL', 'Adja meg a raktáron lévő áruk mennyiségét');

define('TOOLTIP_TELEGRAM_NOTIFICATIONS_ENABLED', 'Engedélyezheti/letilthatja a távirati értesítéseket');
define('TOOLTIP_TELEGRAM_TOKEN', 'Speciális Telegram-fiókok az üzenetek automatikus feldolgozásához és küldéséhez');
define('TOOLTIP_SMS_ENABLE', 'Engedélyezheti/letilthatja az SMS szolgáltatást');
define('TOOLTIP_SMS_CUSTOMER_ENABLE', 'Engedélyezheti / letilthatja az SMS küldését az ügyfélnek vásárláskor');
define('TOOLTIP_SMS_CHANGE_STATUS', 'Az állapot megváltoztatásakor engedélyezheti/letilthatja az SMS-küldést az ügyfélnek');
define('TOOLTIP_SMS_OWNER_ENABLE', 'Vásárláskor engedélyezheti/letilthatja az SMS-t az adminisztrátornak');
define('TOOLTIP_SMS_OWNER_TEL', 'Adja meg/módosítsa a rendszergazda telefonszámát');


define('TOOLTIP_FACEBOOK_AUTH_STATUS', 'Engedélyezheti a felhasználóknak, hogy Facebook-fiókkal jelentkezzenek be webhelyére. Ez egy nagyszerű módja annak, hogy megkönnyítse és kényelmesebbé tegye ezt a folyamatot a felhasználók számára, valamint növelje az új regisztrációk számát.');
define('TOOLTIP_FACEBOOK_APP_ID', 'A közösségimédia-azonosító számok kombinációja, amely megkülönbözteti az egyik fiókot a többitől. Az interneten ez az útlevél analógja, amely gyakran megbízható védelmi módszereket igényel. Az azonosító szám automatikusan generálódik a profil regisztrálásakor. Segítségével megtalálhatja a szükséges információkat, egy személyt vagy egy érdekközösséget.');
define('TOOLTIP_FACEBOOK_APP_SECRET', 'A titkos kulcs egy olyan eszköz, amely megvédi Facebook-fiókját. Ez egy kéttényezős hitelesítési módszer is, amely növeli a biztonsági szintet a fiókjába való bejelentkezéskor.');
define('TOOLTIP_FACEBOOK_PIXEL_ID', 'A Facebook Pixel által gyűjtött adatokkal nyomon követheti a látogatásokat és a konverziókat webhelyén, optimalizálhatja a hirdetéseket, és egyéni célközönségeket hozhat létre az újracélzáshoz.');
define('TOOLTIP_DEFAULT_PIXEL_CURRENCY', 'Adja meg azt a pénznemet, amelyben a termék ára elküldésre kerül a FaceBook Pixel számára');
define('TOOLTIP_FACEBOOK_GOALS_CLICK_ON_BUG_REPORT', 'Célja, hogy leírja az észlelt hibákat, ami lehetővé teszi a fejlesztőcsapat számára a program hibáinak kijavítását.');
define('TOOLTIP_FACEBOOK_GOALS_PHONE_CALL', 'A telefonszámmal ellátott hirdetések megjelenítésével arra ösztönözheti az embereket, hogy hívják fel a cégét rendelés leadása, termékeivel vagy szolgáltatásaival kapcsolatos további információk megszerzése vagy találkozó egyeztetése érdekében.');
define('TOOLTIP_FACEBOOK_GOALS_CLICK_FAST_BUY', 'Ha rendszeresen vásárolnak árut, gyakran a jellemzők már ismertek a vásárló előtt, nem a választás a feladat, hanem a megfelelő megtalálása, kosárba helyezése és gyors rendelés leadása.');
define('TOOLTIP_FACEBOOK_GOALS_CLICK_ON_CHAT', 'A csevegés gomb a webhelyén valahol elhelyezett ikon, amely lehetővé teszi az ügyfelek számára, hogy valós időben kommunikáljanak az ügyfélszolgálati csapattal. Az online chat segítségével szakemberei gyorsan és hatékonyan tudják megoldani az ügyfelek kéréseit.');
define('TOOLTIP_FACEBOOK_GOALS_CALLBACK', 'A visszahívás gomb feladata a potenciális ügyfél kommunikációba hozása.');
define('TOOLTIP_FACEBOOK_GOALS_FILTER', 'A szűrő lehetővé teszi a választék leszűkítését a felhasználó egyéni igényeinek leginkább megfelelő tulajdonságokkal rendelkező választékra.');
define('TOOLTIP_FACEBOOK_GOALS_SUBSCRIBE', 'Lehetővé teszi a felhasználók számára, hogy tematikus e-mailes hírleveleket szervezzenek és tartsanak fenn, amelyekre a szolgáltatás többi felhasználója feliratkozhat.');
define('TOOLTIP_FACEBOOK_GOALS_LOGIN', 'A bejelentkezés az a szó, amely a webhelyre vagy a szolgáltatásra való belépéshez használatos. Nagyon gyakran a bejelentkezés megegyezik a felhasználónévvel, amely a szolgáltatás minden résztvevője számára látható lesz.');
define('TOOLTIP_FACEBOOK_GOALS_ADD_REVIEW', 'Vásárlói vélemények – A felhasználók visszajelzései termékeiről vagy szolgáltatásairól. Termék megvásárlásához a vásárlók 89%-a először olvassa el a véleményeket.');
define('TOOLTIP_FACEBOOK_GOALS_PAGE_VIEW', 'Tudhatja, hányan látták és kérték az Ön webhelyét');
define('TOOLTIP_FACEBOOK_GOALS_ADD_TO_CART', 'A „Kosárba teszem” gomb több termék vásárlását jelenti, amikor azok először kerülnek a kosárba, és ott már leadták a rendelést.');
define('TOOLTIP_FACEBOOK_GOALS_CHECKOUT_PROCESS', 'A bevásárlókosár használatának minősége és kényelme garantálja vásárlói jó hangulatát, hatékony módja a weboldal konverziójának növelésének.');
define('TOOLTIP_FACEBOOK_GOALS_SEARCH_RESULTS', 'A felhasználót a keresési eredményoldalra viszi');
define('TOOLTIP_FACEBOOK_GOALS_VIEW_CONTENT', 'A ViewContent jelzi, ha valaki felkeresi egy weboldal URL-jét.');
define('TOOLTIP_FACEBOOK_GOALS_COMPLETE_REGISTRATION', 'Információnyújtás az ügyfél által az Ön cége által nyújtott szolgáltatásért cserébe');
define('TOOLTIP_FACEBOOK_GOALS_CONTACT_US_REQUEST', 'Olyan személy elérhetőségei, aki valódi érdeklődést mutatott a cég termékei és szolgáltatásai iránt, és a jövőben valódi ügyfélré válhat.');
define('TOOLTIP_FACEBOOK_GOALS_ADD_TO_WISHLIST', 'Az egyik olyan esemény, amely lehetővé teszi a felhasználói műveletek nyomon követését, optimalizálását és közönség létrehozását');
define('TOOLTIP_FACEBOOK_GOALS_ADD_PAYMENT_INFO', 'Az egyik olyan esemény, amely lehetővé teszi a felhasználói műveletek nyomon követését, optimalizálását és közönség létrehozását');
define('TOOLTIP_FACEBOOK_GOALS_SUCCESS_PAGE', 'Az ügyfél egyfajta számlát lát a tökéletes megrendelésről.');

define('TOOLTIP_GOOGLE_OAUTH_STATUS', 'Lehetőség az ügyfélengedélyezés engedélyezésére/letiltására a Google-on keresztül');
define('TOOLTIP_GOOGLE_OAUTH_CLIENT_ID', 'Alapértelmezés szerint a Google egyedi ügyfél-azonosítót – ügyfél-azonosítót – rendel hozzá.');
define('TOOLTIP_GOOGLE_OAUTH_CLIENT_SECRET', 'A CLIENT_SECRET kissé érzékenyebb információk tárolására szolgál, mint például az API-használat, a forgalmi információk és a számlázási információk.');
define('TOOLTIP_GOOGLE_ANALYTICS_AND_TAGS_MODULE_ENABLED', 'Eseménykövető eszközzel rendelkezik, lehetővé teszi a szolgáltatások számára az adatok gyűjtését és elemzések elvégzését');
define('TOOLTIP_GOOGLE_ECOMM_SUCCESS_PAGE', 'Lehetőség a "vásárlás" oldal engedélyezésére / letiltására a megrendelés visszaigazolása után');
define('TOOLTIP_GOOGLE_ECOMM_CHECKOUT_PAGE', 'Lehetőség a pénztári oldal engedélyezésére/letiltására');
define('TOOLTIP_GOOGLE_ECOMM_PRODUCT_DETAIL_PAGE', 'Lehetőség a terméknézeti oldal engedélyezésére/letiltására');
define('TOOLTIP_GOOGLE_ECOMM_SEARCH_RESULTS', 'Lehetőség a keresési eredményoldal engedélyezésére/letiltására');
define('TOOLTIP_GOOGLE_ECOMM_HOME_PAGE', 'Lehetőség a kezdőoldal engedélyezésére / letiltására a böngésző betöltésekor');
define('TOOLTIP_GOOGLE_SITE_VERIFICATION_KEY', 'A Google által biztosított kulcs (csak magát a kulcsot kell behelyeznie)');
define('TOOLTIP_GOOGLE_RECAPTCHA_STATUS', 'Ki-/bekapcsolhatja a Google Recaptchát (megvédi a webhelyeket az internetes robotoktól, és egyúttal segít a könyvek szövegeinek digitalizálásában)');
define('TOOLTIP_GOOGLE_RECAPTCHA_PUBLIC_KEY', 'Google szolgáltatást nyújt (webhelyek internetes robotoktól való védelmére, és egyúttal a könyvszövegek digitalizálásában is)');
define('TOOLTIP_GOOGLE_RECAPTCHA_SECRET_KEY', 'Google szolgáltatást nyújt (webhelyek internetes robotoktól való védelmére, és egyúttal a könyvszövegek digitalizálásában is)');




define('TOOLTIP_ENTRY_FIRST_NAME_MIN_LENGTH', "Minden paraméterhez adja meg a karakterek minimális számát az 'Érték' oszlopban");
define('TOOLTIP_ENTRY_LAST_NAME_MIN_LENGTH', "Minden paraméterhez adja meg a karakterek minimális számát az 'Érték' oszlopban");
define('TOOLTIP_ENTRY_EMAIL_ADDRESS_MIN_LENGTH', "Minden paraméterhez adja meg a karakterek minimális számát az 'Érték' oszlopban");
define('TOOLTIP_MIN_DISPLAY_XSELL', "Minden paraméterhez adja meg a karakterek minimális számát az 'Érték' oszlopban");
...
define('IMAGE_BUTTON_BUY_TEMPLATE','Váltás fizetős csomagra');
...
define('SMS_OWNER_ENABLE_BUY_ONE_CLICK_TITLE', 'SMS-t küldeni az adminnak vásárláskor egy kattintással?');
define('SMS_OWNER_TEL_TITLE', 'Admin tel. number');
define('SMS_TEXT_TITLE', 'text sms');
define('SMS_LOGIN_TITLE', 'Bejelentkezés az SMS-átjáróba (vagy API-kulcsba, Account SID)');
define('SMS_PASSWORD_TITLE', 'pass (or Auth token)');
define('SMS_SIGN_TITLE', 'Feladó (or Service SID)');
...
define('GOOGLE_FEED_CHOOSE_ALL_PRODUCTS_TITLE', 'aktív terméket');
define('GOOGLE_FEED_CHOOSE_PRODUCTS_2_TITLE', 'aktív XML állapotú terméket');
define('GOOGLE_FEED_CHOOSE_PRODUCTS_3_TITLE', 'olyan terméket, amely rendelkezésre áll készleten');
...
define('QTY_PRO_ENABLED_TITLE', 'Az attribútumok kombinációi');
...
define('DOMEN_IN_ROBOTS_TXT_RECOMMENDATION_TEXT', '<span class="robots-txt-text">a Robots.txt-ben a Host direktíva nem egyezik az Ön webhelyének nevével, a sikeres promóció érdekében javasoljuk</span> <span class="generate-robots-txt-process">Feldolgozás ... kérem, várjon</span><a class="start-generate-robots-txt" href="javascript:void(0);"> regenerálódni</a>');
...
define('TOOLTIP_SMS_CODE_1', 'Telefonszám vagy alfanumerikus feladó.');
...
define('INFO_ICON_ENABLE_SMTP', 'Bekapcsoláskor ellenőrizze az SMTP beállításait');
define('SMTP_CONF_TITLE', 'SMTP beállítások');
...
define('SEO_SETTINGS_CONF_TITLE','SEO beállítások');

define('HEADER_BUY_TEMPLATE_LINK','Váltás fizetős csomagra');

define('NWPOSHTA_DELIVERY_TITLE', 'Új postai kézbesítési cím');
define('TEXT_CATEGORIES', 'Kategóriák');
define('HEADING_TITLE_GOTO', 'Ugrás:');
define('ERROR_DOMAIN_IN_USE','Hiba! Ez a tartomány már használatban van');
define('ERROR_ANAME_MISMATCH', 'Hiba! Az A-név nem egyezik a 167.172.41.152-vel. Próbáld meg később');
define('SUCCESS_DOMAIN_CHANGE', 'Siker! A domain megváltozott');
define('ERROR_ADD_DOMAIN_FIRST','Először csatlakoztassa egyéni domainjét!');
define('ERROR_BASH_EXECUTION','Hiba a szkript futtatásakor, kapcsolatkezelő');
define('PRODUCTS_LIMIT_REACHED_FREE', 'Termékkorlát túllépve! Webhelye %s napon belül automatikusan letiltásra kerül. <a href="%s">Bérlési díj</a> vagy a nem kívánt termékek eltávolítása');
define('PRODUCTS_LIMIT_REACHED_JUNIOR', 'Túllépte a termékkorlátot! %s napon belül webhelye automatikusan frissül a SEO csomagra.');
define('PRODUCTS_LIMIT_REACHED_SEO', 'Túllépte a termékkorlátot! %s napon belül webhelye automatikusan profi csomagra frissül');
define('PRODUCTS_LIMIT_REACHED_HEADING', 'Termékkorlát túllépve!');
define('ERROR_SIMLINK_CREATE', 'Szimlink nincs létrehozva');
define('ERROR_FOLDER_RENAME', 'A mappa nincs másolva');
