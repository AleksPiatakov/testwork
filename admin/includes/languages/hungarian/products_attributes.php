...
define('TABLE_HEADING_OPT_LENGTH', 'Show in filter');
define('TABLE_HEADING_OPT_COMMENT', 'Show in product listing');
...
define('TEXT_OPTION_GROUP_NAME', 'Name of the attribute group');
define('TEXT_OPTION_VALUE_NAME','Attribútumérték neve');
?>