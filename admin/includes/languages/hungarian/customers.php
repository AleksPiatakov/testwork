...
define('ENTRY_CUSTOMERS_DISCOUNT', 'Personal discount:');
...
// view address_book
define('AD_CHOOSE_ADDRESS', 'Address');
...
//Error form
define('ERROR_NEW_PASSWORD_MIN_LENGTH', 'Min length of password is equal %s');
define('ERROR_CONFIRM_PASSWORD_EQUAL', 'Passwords must be equal');
