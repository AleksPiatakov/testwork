...
define('COUPON_FOR_EVERY_PRODUCT', 'Use for each suitable product');
...
define('COUPON_FOR_EVERY_PRODUCT_HELP', 'The coupon discount will be applied to every eligible item in the cart. The option works only if there is a restriction on the product or category.');
