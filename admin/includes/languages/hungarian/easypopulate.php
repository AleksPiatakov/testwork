...
define('EASY_LABEL_ALGORITHM', 'Import Algorithm');
define('EASY_LABEL_DELIMITER', 'Delimiter');
define('EASY_SELECT_FILE', 'Select file');
define('EASY_EXPORT_DATA', 'Export data');
define('EASY_LABEL_EXPORT_FULL_ATTR_INF', 'Töltse le a teljes attribútum-információt');
define('EASY_LABEL_IMPORT_FULL_ATTR_INF', 'Töltse le a teljes attribútum-információt');
