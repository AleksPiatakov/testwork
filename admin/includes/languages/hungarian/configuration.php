...
define('TABLE_HEADING_CONFIGURATION_SHOW_FIELD', 'Mező megjelenítése');
define('TABLE_HEADING_CONFIGURATION_REQUIRED_VALUE', 'Kötelező');
...
define('SEO_ADD_PARENT_CATEGORIES_TO_URL_TITLE', 'Hozzáadja a szülő kategóriák azonosítóit az URL -hez?');
...
define('ENTRY_SUBURB_MIN_LENGTH_TITLE', 'Külváros');
...
define('ACCOUNT_FIRST_NAME_TITLE' , 'Név');
...
define('STOCK_DISABLE_NON_EXISTENT_PRODUCT_ON_CHECKOUT_TITLE', 'A beváltott termékek letiltása');
...
define('STOCK_DISABLE_NON_EXISTENT_PRODUCT_ON_CHECKOUT_DESC', 'Vásárlás után tiltsa le a 0-s számú termékeket');
...
define('GET_BROWSER_LANGUAGE_TITLE', 'Webhely váltása böngésző nyelvére');
...
define('GOOGLE_GOALS_PAGE_VIEW_TITLE', 'A \'oldalmegtekintés\' cél az egyes oldalak megtekintése');
define('GOOGLE_GOALS_ADD_TO_CART_TITLE', 'A \'add_to_cart\' cél az, amikor az ügyfél hozzáad egy tételt a kosárhoz');
define('GOOGLE_GOALS_ON_CHECKOUT_TITLE', 'A \'checkout_view\' cél a fizetési oldal megtekintése');
define('GOOGLE_GOALS_CHECKOUT_PROCESS_TITLE', 'Cél \'checkout_progress\' - az ügyfél sikeresen leadta a rendelést');
define('GOOGLE_GOALS_CHECKOUT_SUCCESS_TITLE', 'A \'checkout_success\' célja az oldal megtekintése a rendelés megerősítése után');
define('GOOGLE_GOALS_CLICK_FAST_BUY_TITLE', 'Cél \'gyors_vásárlás\' - amikor az ügyfél a termékoldalon a "Gyorsrendelés" gombra kattint');
define('GOOGLE_GOALS_LOGIN_TITLE', 'Cél \'bejelentkezés\' az, amikor az ügyfél be van jelentkezve');
define('GOOGLE_GOALS_ADD_REVIEW_TITLE', 'Vélemény hozzáadása\' cél az, amikor egy ügyfél véleményt adott hozzá');
define('GOOGLE_GOALS_FILTER_TITLE', 'A \'szűrő\' célja, amikor az ügyfél szűrőt használ a termékek keresésére');
define('GOOGLE_GOALS_CALLBACK_TITLE', 'Cél \'visszahívás\' - amikor az ügyfél rákattint a \'Visszahívás\' gombra a webhely fejlécében');
define('GOOGLE_GOALS_CLICK_ON_PHONE_TITLE', 'A \'telefon_hívás\' cél az, amikor az ügyfél a telefon ikonjára kattint');
define('GOOGLE_GOALS_CLICK_ON_CHAT_TITLE', 'A \'click_chat\' cél az, amikor az ügyfél a chatre kattint');
define('GOOGLE_GOALS_CONTACT_US_TITLE', 'Cél \'contact_us\' - amikor az ügyfél kérelmet nyújtott be a kapcsolatfelvételi oldalon');
define('GOOGLE_GOALS_SUBSCRIBE_TITLE', 'Cél \'feliratkozás\' - amikor az ügyfél feliratkozott');
define('GOOGLE_GOALS_CLICK_ON_BUG_REPORT_TITLE', 'A \'bug_report\' cél az, amikor az ügyfél rákattint a \'Hibajelentés elküldése\' lehetőségre a webhely láblécében');

define('GOOGLE_ECOMM_SUCCESS_PAGE_TITLE', 'E-kereskedelmi vásárlás \'vásárlás\' - oldalmegtekintés a rendelés megerősítése után');
define('GOOGLE_ECOMM_CHECKOUT_PAGE_TITLE', 'E-kereskedelmi cél \'kosár\' - Checkout oldal');
define('GOOGLE_ECOMM_PRODUCT_DETAIL_PAGE_TITLE', 'A \'termék\' e-kereskedelmi célja a termékoldal megtekintése');
define('GOOGLE_ECOMM_SEARCH_RESULTS_TITLE', 'E-kereskedelmi cél \'keresési eredmények\' - keresési eredményoldal megtekintése');
define('GOOGLE_ECOMM_HOME_PAGE_TITLE', 'Az e-kereskedelmi cél \'home\' a termékoldal megtekintése');
define('GOOGLE_ECOMM_CLICK_FAST_BUY_TITLE', 'Ecommerce Goal \'Purchase\' - when customer accept \'Quick order\' on product page');

define('DOMEN_URL_TITLE', 'Domen cím');
define('STORE_TIME_ZONE_TITLE', 'Időzóna');
define('DOMEN_URL_DESC', 'Beállíthatja saját doménnevét');
define('STOCK_ALLOW_CHECKOUT_WITH_ATTR_COUNT_0_TITLE', 'Engedélyezze a vásárlást 0-val a termékattribútumokban');
define('STOCK_ALLOW_CHECKOUT_WITH_ATTR_COUNT_0_DESC', 'Engedélyezze a vásárlást, ha a mennyiség 0 a termékattribútumokban');
define('SSL_EXIST', 'Tanúsítvány kiállítva');
define('SSL_NON_EXIST', 'Tanúsítvány kiadása');
define('SSL_ARE_YOU_SURE', 'Ez megkezdi a személyes SSL-tanúsítvány generálását a tartományhoz. Biztos benne?');
define('QUICK_ORDER_ENABLED_TITLE' , 'Gyors rendelés gomb');