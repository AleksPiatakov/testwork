...
define('TEXT_PROD_LOAD_FILES','Fájlok betöltése:');
define('TEXT_ALOWED_FILE_TYPES','Engedélyezett fájltípusok:');
define('TEXT_PROD_FILES_DRAG','Húzd ide a fájlokat');
define('TEXT_PROD_DOWNLOADS','Letöltendő fájlok');
define('TEXT_IS_DOWNLOAD_PRODUCT','Elektronikus termék:');
...
define ('TEXT_QTY_PRO_QUANTITY_LABEL', 'Mennyiség');
define('TEXT_QTY_PRO_COMBINATION_PRICE_LABEL', 'Ár');
define ('TEXT_QTY_PRO_VENDOR_CODE_LABEL', 'Szállítói kód');
...
define('TEXT_EMPTY_ATTRIBUTES', 'Először adjon hozzá egy attribútumot a termékhez legalább két értékkel.');
...
define('BUTTON_QUICK_VIEW', 'Quick view');
define('TEXT_LINK_TO_YOUTUBE', 'Link a Youtube-videóhoz');
define('TEXT_IMAGE_PREVIEW', 'Előnézet');
define('TEXT_CHOOSE_ON_SERVER', 'Válasszon a szerveren');