...
define('TEXT_EDIT_CATEGORIES_DISPLAY_PRODUCTS', 'Display products:');
...
define('TEXT_INFO_DELETE_FROM_CATEGORY', 'Select the category from which you want to remove this product');
...
define('TEXT_EDIT_CATEGORIES_DISPLAY_PRODUCTS_NOTHING','Nothing');
define('TEXT_EDIT_CATEGORIES_DISPLAY_PRODUCTS_ALL','All products of subcategories');
define('TEXT_EDIT_CATEGORIES_DISPLAY_PRODUCTS_TOP','TOP sales of this category');
define('TEXT_EDIT_CATEGORIES_DISPLAY_PRODUCTS_RECOMMENDED','Recommended for this category');
define('TEXT_EDIT_CATEGORIES_DISPLAY_PRODUCTS_NEW','Novelties of this category');
define('TEXT_ID_XML_CATEGORY','ID XML kategória');
define('TEXT_VENDOR_XML_CATEGORY','Vendor XML kategória');
define('ERROR_SYS_CATEGORY_EXIST','A %s kategória XML azonosítóját már <a href="'.DIR_WS_ADMIN . 'categories.php?cID=%s&action=edit_category" target="_blank">egy másik kategória</a>');
?>