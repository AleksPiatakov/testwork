...
define('MODULE_PAYMENT_BANK_CART_TRANSFER_STATUS_TITLE', 'Előre utalás a kártyára');
define('MODULE_PAYMENT_BANK_CART_TRANSFER_STATUS_DESC', 'Szeretné használni a Kártya-előfizetés modult? 1 - igen, 0 - nem');
define('MODULE_PAYMENT_BANK_CART_TRANSFER_1_TITLE', 'Bank neve');
define('MODULE_PAYMENT_BANK_CART_TRANSFER_1_DESC', 'Adja meg a bank nevét');
define('MODULE_PAYMENT_BANK_CART_TRANSFER_2_TITLE', 'Kártyaszám');
define('MODULE_PAYMENT_BANK_CART_TRANSFER_2_DESC', 'Adja meg kártyaszámát');
define('MODULE_PAYMENT_BANK_CART_TRANSFER_3_TITLE', 'Címzett');
define('MODULE_PAYMENT_BANK_CART_TRANSFER_3_DESC', 'Kifizetés címzettje');
define('MODULE_PAYMENT_BANK_CART_SORT_ORDER_TITLE', 'Rendezési sorrend');
define('MODULE_PAYMENT_BANK_CART_SORT_ORDER_DESC', 'Modul rendezési sorrend');
...
define('MODULE_SHIPPING_EXPRESS_SHIPPING_PRICE_TEXT_TITLE', 'Szállítási ár szöveg');
define('MODULE_SHIPPING_EXPRESS_SHIPPING_PRICE_TEXT_DESC', 'Hagyja üresen, ha a költségmezőben megadott árat kívánja használni');
...
define('MODULE_SHIPPING_NWPOCHTA_SHIPPING_PRICE_TEXT_TITLE', 'Szállítási ár szöveg');
define('MODULE_SHIPPING_NWPOCHTA_SHIPPING_PRICE_TEXT_DESC', 'Hagyja üresen, ha a költségmezőben megadott árat kívánja használni');
...
define('SHIPPING_TAB_TITLE', 'Szállítás');
define('SHIPPING_TO_PAYMENT_TAB_TITLE', 'Szállítás fizetésre');
define('SHIPPING_TO_FIELDS_TAB_TITLE', 'Szállítás mezőkre');
define('SHIPPING_UPDATE_WAREHOUSES_TITLE', 'Frissítse a raktárakat');
define('MODULE_SHIPPING_NWPOSHTANEW_STATUS_TITLE', 'Új levelező modul engedélyezése');
define('MODULE_SHIPPING_NWPOSHTANEW_STATUS_DESC', 'Engedélyezi az Új levelek modult?');
define('MODULE_SHIPPING_NWPOSHTANEW_COST_TITLE', 'Költség');
define('MODULE_SHIPPING_NWPOSHTANEW_CUSTOM_NAME_TITLE', 'Egyéni név');
define('MODULE_SHIPPING_NWPOSHTANEW_CUSTOM_NAME_DESC', 'Hagyja üresen ezt a mezőt, ha az alapértelmezett nevet szeretné használni');
define('MODULE_SHIPPING_NWPOSHTANEW_COST_DESC', 'A szállítási mód használatának költsége.');
define('MODULE_SHIPPING_NWPOSHTANEW_TAX_CLASS_TITLE', 'Adó');
define('MODULE_SHIPPING_NWPOSHTANEW_TAX_CLASS_DESC', 'Adó felhasználása.');
define('MODULE_SHIPPING_NWPOSHTANEW_ZONE_TITLE', 'Zóna');
define('MODULE_SHIPPING_NWPOSHTANEW_ZONE_DESC', 'Ha egy zóna ki van választva, ez a szállítási modul csak a kiválasztott zónában lévő ügyfelek számára lesz látható.');
define('MODULE_SHIPPING_NWPOSHTANEW_SORT_ORDER_TITLE', 'Rendezési sorrend');
define('MODULE_SHIPPING_NWPOSHTANEW_SORT_ORDER_DESC', 'Modul rendezési sorrendje.');
define('MODULE_SHIPPING_NWPOSHTANEW_API_KEY_TITLE', 'API kulcs');
define('MODULE_SHIPPING_NWPOSHTANEW_API_KEY_DESCRIPTION', 'Szükséges lehet a raktárak frissítéséhez');
define('MODULE_SHIPPING_NWPOSHTANEW_SHOW_SHIPPING_COST_STATUS_TITLE', 'Szállítási költség megjelenítése');
define('MODULE_SHIPPING_NWPOSHTANEW_SHIPPING_PRICE_TEXT_TITLE', 'Szállítási ár szöveg');
define('MODULE_SHIPPING_NWPOSHTANEW_SHIPPING_PRICE_TEXT_DESC', 'Hagyja üresen, ha a költségmezőben megadott árat kívánja használni');
