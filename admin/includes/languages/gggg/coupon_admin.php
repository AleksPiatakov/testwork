...
define('HEADING_TITLE', 'Промо-коды');
...
define('COUPON_FOR_EVERY_PRODUCT', 'Использовать для каждого подходящего продукта');
...
define('COUPON_FOR_EVERY_PRODUCT_HELP', 'Скидка купона будет применена к каждому подходящему товару в корзине. Опция работает только если есть ограничение по товару или категории.');
...
define('TEXT_TOOLTIP_VOUCHER_EMAIL', 'Отправить купон на e-mail');
define('TEXT_TOOLTIP_VOUCHER_EDIT', 'Редактировать купон');
define('TEXT_TOOLTIP_VOUCHER_DELETE', 'Удалить купон');
define('TEXT_TOOLTIP_VOUCHER_REPORT', 'Отчет по купону');
