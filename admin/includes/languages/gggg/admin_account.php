...
define('TEXT_INFO_ERROR', 'Данный Email адрес уже зарегистрирован! Попробуйте ещё раз.');
...
define('TEXT_INFO_INTRO_CONFIRM_PASSWORD_ERROR', '<b>ОШИБКА:</b> неверный пароль!');
define('TEXT_INFO_INTRO_DEFAULT', 'Нажмите кнопку <b>изменить</b> для редактирования данных.');
define('TEXT_INFO_INTRO_DEFAULT_FIRST_TIME', '<br><b>ВНИМАНИЕ:</b><br>Здравствуйте, <b>%s</b>, Вы зашли сюда в первый раз. Мы рекомендуем Вам изменить свой пароль!');
define('TEXT_INFO_INTRO_DEFAULT_FIRST', '<br><b>ВНИМАНИЕ:</b><br>Здравствуйте, <b>%s</b>, мы рекомендуем Вам изменить email адрес (admin@localhost) и пароль!');
