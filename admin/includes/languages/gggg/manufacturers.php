...
define('TABLE_HEADING_DESC', 'Описание');

define('TABLE_HEADING_META_DESC', 'Мета описание');
define('TABLE_HEADING_META_KEYWORDS', 'Ключевые слова');
define('TABLE_HEADING_META_TITLE', 'Мета заголовок');
...
define('TEXT_MANUFACTURERS_SORT', 'Сортировка:');
...
define('TEXT_MANUFACTURERS_ON', 'Вкл');
define('TEXT_MANUFACTURERS_OFF', 'Выкл');
define('TEXT_MANUFACTURERS_H1', 'H1 производитель');
define('TEXT_MANUFACTURERS_SEO_TOP', 'Seo text top блок');
