...
function new_tep_draw_date_selector($prefix, $date='', $parameters = '') {
  if (!empty($parameters)) {
  ...
  $date_selector = '<select name="' . $prefix . '_day"' . $parameters . '>';
  for ($i = 1; $i < 32; $i++) {
    $date_selector .= '<option value="' . $i . '"';
  ...
  $date_selector .= '<select name="'. $prefix .'_month"' . $parameters . '>';
  for ($i = 1; $i < 13; $i++) {
    $date_selector .= '<option value="' . $i . '"';
  ...
  $date_selector .= '<select name="'. $prefix .'_year"' . $parameters . '>';
  for ($i = 2015; $i < 2025; $i++) {
    $date_selector .= '<option value="' . $i . '"';
