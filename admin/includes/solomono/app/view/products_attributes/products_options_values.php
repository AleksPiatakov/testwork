...
<div class="wrapper-title">
    <div class="bg-light lter ng-scope">
        <h1 class="m-n font-thin h3"><?php echo HEADING_TITLE_VAL;?></h1>
...
<div class="row row_pagin_admin">
	<div class="col-md-6 col-sm-12 text-left pagin_admin">
	...
	<div id="own_pagination" class="col-md-6 col-sm-12 text-right"></div>
</div>
...
<div style="display: none" id="action" align="center">
    ...
    <button data-toggle="tooltip" data-action="delete_<?php echo $action?>" data-ajax="true"  data-placement="top" title="<?php echo TEXT_MODAL_DELETE_ACTION?>" class="btn_own del_link">
