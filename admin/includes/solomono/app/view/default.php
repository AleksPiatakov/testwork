...
<div class="wrapper-title">
    <div class="bg-light lter ng-scope">
        <h1 class="m-n font-thin h3"><?php echo isset($data['title']['label']) ? $data['title']['label'] : HEADING_TITLE;?></h1>
...
<div class="row row_pagin_admin">
    ...
    <?php echo (new ShowMore)->init($action, $action . '.php'); ?>
    <div id="own_pagination"></div>
</div>

<!--  button for action -->
<div style="display: none" id="action" align="center">
    <button class="btn_own edit_row" data-action="edit_<?php echo $action?>" data-toggle="tooltip" data-placement="top" title="<?php echo TOOLTIP_CLIENT_GROUP_EDIT?>">
