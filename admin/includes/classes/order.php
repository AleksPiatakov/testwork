    ...
    function query($order_id) {
        ...
        while ($totals=tep_db_fetch_array($totals_query)) {
            ...
            if ($totals['class'] == 'ot_shipping') {
                $totals['title'] = trim($totals['title']);
                if (mb_substr($totals['title'], -1, 1) === ':') {
                    $this->info['shipping_name'] = mb_substr($totals['title'], 0, (mb_strlen($totals['title']) - 1));
                } else {
                    $this->info['shipping_name'] = $totals['title'];
                }
            }
        }
