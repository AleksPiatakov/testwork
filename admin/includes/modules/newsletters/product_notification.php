...
//--></script>';
    ...
    function confirm() {
      ...
      $confirm_string .= '<a href="' . tep_href_link(FILENAME_NEWSLETTERS, 'page=' . $_GET['page'] . '&nID=' . $_GET['nID'] . '&action=send') . '">' . tep_text_button(BUTTON_CANCEL) . '</a> <a href="' . tep_href_link(FILENAME_NEWSLETTERS, 'page=' . $_GET['page'] . '&nID=' . $_GET['nID']) . '">' . tep_text_button(BUTTON_CANCEL) . '</a></td>' . "\n" .
                         '  </tr>' . "\n" .
                         '</table>';
    ...
    function send($newsletter_id) {
      ...
      while (list($key, $value) = each ($audience)) {
        //$mimemessage->send($value['firstname'] . ' ' . $value['lastname'], $value['email_address'], '', (EMAIL_FROM ?: STORE_OWNER_EMAIL_ADDRESS), $this->title);
