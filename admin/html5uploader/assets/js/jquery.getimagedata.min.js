...
var h=function(b){(a[w]||m)();b=s;s=void 0;b?k(b[0]):t(M)};a[x]=a[I]=h;a.src=d;j.insertBefore(a,j.firstChild);c&&j.insertBefore(c,j.firstChild)}},0);return a}var q="async",Q="charset",v="",M="error",L="_jqjsp",w="onclick",x="on"+M,I="onload",H="onreadystatechange",J="removeChild",K="<script/>",z="success",B="timeout",N=e.browser,j=e("head")[0]||
...
(function(e){e.getImageData=function(b){var m=/(ftp|http|https):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?/;if(b.url){var r="https:"===location.protocol,c="",c=b.server&&m.test(b.server)&&!(r&&0==b.server.indexOf("http:"))?b.server:b.server;e.jsonp({url:c+"?callback=?",data:{url:escape(b.url)},dataType:"json",timeout:1E4,success:function(c){var q=new Image;e(q).load(function(){this.width=c.width;this.height=c.height;typeof b.success==typeof Function&&b.success(this)}).attr("src",
