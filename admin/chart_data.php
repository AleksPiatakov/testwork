...
$g->x_grid_colour = '0xebebeb';
$g->y_grid_colour = '0xebebeb';

$g->title( tep_iconv_utf(HEADING_TITLE) . ': ' . $report_desc, '{font-size: 18px;}' );

$g->set_data( $data_sum );
$g->bar( 60, '#00b3ff', tep_iconv_utf(TEXT_TOTAL_SUMM), 12 );

$g->set_data( $data_count );
$g->line_hollow( 3, 4, '#16bb00', tep_iconv_utf(TEXT_NUMBER_OF_ORDERS), 12 );
...
$g->set_data( $data_count );
$g->line_hollow( 3, 4, '0x16bb00', tep_iconv_utf(TEXT_NUMBER_OF_ORDERS), 12 );

$g->set_data( $data_sum );
$g->line_dot( 3, 4, '0x00b3ff', tep_iconv_utf(TEXT_TOTAL_SUMM), 12 );
