                                ...
                                <tr>
                                                ...
                                                <td colspan="2">
                                                    <table border="0" width="100%" cellspacing="0" cellpadding="2">
                                                        ...
                                                        if (empty($action)) {
                                                            ?>
                                                            <tr>
                                                                <td colspan="2" align="right"><?php echo '<a href="' . tep_href_link(FILENAME_TAX_CLASSES, 'page=' . $_GET['page'] . '&action=new') . '">' . tep_text_button(BUTTON_NEW_TAX_CLASS_NEW) . '</a>'; ?></td>
                                                            </tr>
                                                            <?php
                                                        }
                                                        ?>
                                    ...
                                    switch ($action) {
                                        case 'new':
                                            ...
                                            $contents[]=array(
                                                'align'=>'center',
                                                'text'=>'<br>' . tep_image_submit('button_insert.gif', IMAGE_INSERT) . '&nbsp;<a href="' . tep_href_link(FILENAME_TAX_CLASSES, 'page=' . $_GET['page']) . '">' . tep_text_button(BUTTON_CANCEL_NEW) . '</a>'
                                            );
                                            break;
                                        case 'edit':
                                            ...
                                            $contents[]=array(
                                                'align'=>'center',
                                                'text'=>'<br>' . tep_image_submit('button_update.gif', IMAGE_UPDATE) . '&nbsp;<a href="' . tep_href_link(FILENAME_TAX_CLASSES, 'page=' . $_GET['page'] . '&tID=' . $tcInfo->tax_class_id) . '">' . tep_text_button(BUTTON_CANCEL_NEW) . '</a>'
                                            );
                                            break;
                                        case 'delete':
                                            ...
                                            $contents[]=array(
                                                'align'=>'center',
                                                'text'=>'<br>' . tep_image_submit('button_delete.gif', IMAGE_DELETE) . '&nbsp;<a href="' . tep_href_link(FILENAME_TAX_CLASSES, 'page=' . $_GET['page'] . '&tID=' . $tcInfo->tax_class_id) . '">' . tep_text_button(BUTTON_CANCEL_NEW) . '</a>'
                                            );
                                            break;
                                        default:
                                            if (isset($tcInfo) && is_object($tcInfo)) {
                                                ...
                                                $contents[]=array(
                                                    'align'=>'center',
                                                    'text'=>'<a href="' . tep_href_link(FILENAME_TAX_CLASSES, 'page=' . $_GET['page'] . '&tID=' . $tcInfo->tax_class_id . '&action=edit') . '">' . tep_text_button(BUTTON_EDIT_NEW) . '</a> <a href="' . tep_href_link(FILENAME_TAX_CLASSES, 'page=' . $_GET['page'] . '&tID=' . $tcInfo->tax_class_id . '&action=delete') . '">' . tep_text_button(BUTTON_DELETE_NEW) . '</a>'
                                                );
