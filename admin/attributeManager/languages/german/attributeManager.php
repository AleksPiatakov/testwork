...
define('AM_AJAX_OPTION_VALUES_ADD','hinzufügen');
define('AM_AJAX_OPTION_VALUES_CREATE','erschaffen');
define('AM_AJAX_OPTION_VALUES_DELETE','löschen');

define('AM_AJAX_OPTION_VALUES_NAME','Wert');
define('AM_AJAX_OPTION_VALUES_PRICE_PREFIX','Preispräfix');
define('AM_AJAX_PC','pc.');
define('AM_AJAX_OPTION_VALUES_PRICE','Preis');
define('AM_AJAX_OPTION_VALUES_QUANTITY','Menge');
define('AM_AJAX_OPTION_VALUES_ARTICLE', 'Article');
define('AM_AJAX_OR', 'oder');
