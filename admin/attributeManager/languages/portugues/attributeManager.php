...
define('AM_AJAX_NAME', 'Nome do Atributo<a class="ajuda" href="#"><img src="layout/help1.gif" width="24" height="16" border="0"><span>Atenзгo:<BR>
            Aqui vocк pode criar atributos para os Produtos e dar-lhes opзхes e valores diferentes. Os atributos servem para que vocк cadastre variedade de um mesmo produto. EX:<BR> "Opзгo" Tamanho = "Valores" P, M e G<BR>"Opзгo" Cor = "Valores" Azul, Preta, Rosa e Amarela<BR>"Opзгo" Voltagem = "Valores" 110v e 220v<BR>Os valores dos atributos tambйm podem ter preзos diferentes, para isto utilize o prefix + ou - e preencha o campo "Diferenзa de Preзo".<BR>Use os "GABARITOS" para salvar suas combinaзхes de atributos e inserн-las rapidamente mais tarde. </span></a>
            ');
