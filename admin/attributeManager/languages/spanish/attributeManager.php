...
define('AM_AJAX_ENTER_NEW_OPTION_VALUE_NAME_TO_ADD_TO', 'Nuevo nombre de valor a aсadir a %s');
...
define('AM_AJAX_PROMPT_LOAD_TEMPLATE', 'Seguro que quiere recuperar %s de la plantilla? <br />Se sobreescribirбn los atributos actuales del producto. La operaciуn no se puede deshacer');
...
define('AM_AJAX_PROMPT_DELETE_TEMPLATE', 'Confirme borrado de la plantilla %s?<br>La operaciуn no se puede deshacer!');

//attributeManager.php

define('AM_AJAX_ADDS_ATTRIBUTE_TO_OPTION', 'Adds the selected attribute on the left to the %s option');
define('AM_AJAX_ADDS_NEW_VALUE_TO_OPTION', 'Aсade un nuevo valor a la opciуn %s');
define('AM_AJAX_PRODUCT_REMOVES_OPTION_AND_ITS_VALUES', 'Borra la opciуn %1$s y los %2$d valor(es) por debajo de la opciуn de este producto');
...
define('AM_AJAX_ADDS_NEW_OPTION', 'Aсadir una nueva opciуn a la lista');
define('AM_AJAX_OPTION', 'Opciуn:');
...
define('AM_AJAX_ADDS_ATTRIBUTE_TO_PRODUCT', 'Aсadir el atributo al producto actual');
define('AM_AJAX_QUANTITY', 'Cantidad');
define('AM_AJAX_PRODUCT_REMOVE_ATTRIBUTE_COMBINATION_AND_STOCK', 'Elimina esta combinaciуn de atributos y las existencias del producto');
define('AM_AJAX_UPDATE_OR_INSERT_ATTRIBUTE_COMBINATIONBY_QUANTITY', 'Insertar o actualizar el atributo en combinaciуn con la cantidad determinada');
...
define('AM_AJAX_FILE_DAYS', 'Dнas');
define('AM_AJAX_FILE_COUNT', 'descargas mбximas');
define('AM_AJAX_DOWLNOAD_EDIT', 'Editar opcion de descarga');
define('AM_AJAX_DOWLNOAD_ADD_NEW', 'Aсadir opcion de descarga');
define('AM_AJAX_DOWLNOAD_DELETE', 'Borrar opcion de descarga');
define('AM_AJAX_HEADER_DOWLNOAD_ADD_NEW', 'Aсadir opcion de descarga para \"%s\"');
...
define('AM_AJAX_FIRST_SAVE', 'Hay que guardar el producto antes de aсadir opciones');
