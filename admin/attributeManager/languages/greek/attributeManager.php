...
define('AM_AJAX_PROMPT_LOAD_TEMPLATE', 'Are you sure you want to load the %s Template? <br />This will overwrite this products current attributes and cannot be undone.');
...
define('AM_AJAX_ADDS_ATTRIBUTE_TO_OPTION', 'Adds the selected attribute on the left to the %s attribute');
define('AM_AJAX_ADDS_NEW_VALUE_TO_OPTION', 'Adds a new value to the %s attribute');
define('AM_AJAX_PRODUCT_REMOVES_OPTION_AND_ITS_VALUES', 'Removes the attribute %1$s and the %2$d attribute value(s) below it  from this product');
...
define('AM_AJAX_NAME', 'Attributes');
...
define('AM_AJAX_MOVES_VALUE_UP', 'Moves attribute value up');
define('AM_AJAX_MOVES_VALUE_DOWN', 'Moves attribute value down');
define('AM_AJAX_ADDS_NEW_OPTION', 'Adds a new attribute to the list');
define('AM_AJAX_OPTION', 'Attribute:');
...
define('AM_AJAX_SORT', 'Sort:');
define('AM_AJAX_ADDS_NEW_OPTION_VALUE', 'Adds a new attribute value to the list');
...
define('AM_AJAX_DOWLNOAD_EDIT', 'Edit download attribute');
define('AM_AJAX_DOWLNOAD_ADD_NEW', 'Add download attribute');
define('AM_AJAX_DOWLNOAD_DELETE', 'Delete download attribute');
define('AM_AJAX_HEADER_DOWLNOAD_ADD_NEW', 'Add download attribute for \"%s\"');
define('AM_AJAX_HEADER_DOWLNOAD_EDIT', 'Edit download attribute for \"%s\"');
define('AM_AJAX_HEADER_DOWLNOAD_DELETE', 'Delete download attribute from \"%s\"');
define('AM_AJAX_FIRST_SAVE', 'Save Product before adding attributes');

//----------------------------
// EOF Change: download attributes for AM
//-----------------------------

define('AM_AJAX_OPTION_NEW_PANEL','New attribute');
