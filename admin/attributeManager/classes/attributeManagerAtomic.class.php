...
class attributeManagerAtomic extends attributeManager {
	 ...
	 * @return void
	 */
	function __construct(&$arrSessionVar) {
...
function addAttributeToProduct($get) {
  ...
  if(isset($get['sortOrder'])) {
    ...
    if(isset($get['pa_qty'])) {
      $this->getAndPrepare('pa_qty', $get, $getArray['pa_qty']);
    }

    if(isset($get['pa_article'])) {
      $this->getAndPrepare('pa_article', $get, $getArray['pa_article']);
    }
...
// QT pro
	...
	function update($get) {
        ...
        $this->arrSessionVar[$id]['pa_qty'] = $getArray['pa_qty'];
        $this->arrSessionVar[$id]['pa_article'] = $getArray['pa_article'];
	...
	function getAllProductOptionsAndValues($reset = false) {
        ...
        $this->arrAllProductOptionsAndValues[$optionsId]['values'][$res['option_value_id']]['pa_qty'] = $res['pa_qty'];
        $this->arrAllProductOptionsAndValues[$optionsId]['values'][$res['option_value_id']]['pa_article'] = $res['pa_article'];
...
//			while( list($currentOptionValuekey, $currentOptionValues) = each($currentOption['values']) ){
					...
					$sortedArray[$sortorder] =  array( 'optionValue-id' => $currentOptionValuekey,
                            ...
                            'optionValue-pa_qty' => $currentOptionValues['pa_qty'],
                            'optionValue-pa_article' => $currentOptionValues['pa_article'],
		...
		// while( list($key, $currentOption) = each($sortedArray) ){
			...
			$optionValues[$currentOption['optionValue-id']] = array(
                                  ...
                                  'pa_qty' => $currentOption['optionValue-pa_qty'],
                                  'pa_article' => $currentOption['optionValue-pa_article'],
