...
/**
 * OSC Database public static functions wrapper - just in case they decide to release ms3 the moment i release this - he he
 */
class amDB {
	 ...
	 * database public static functions. This can cause the internal, last insert id to be 
	 * wrong if the link id isn't included in the mysqli_insert_id statement.
	 * For this reason i have not used the default osc public static function for this one as for some
	 * reason they haven't put the link in their wrapper public static function.
	 * @author Sam West aka Nimmit - osc@kangaroopartners.com
