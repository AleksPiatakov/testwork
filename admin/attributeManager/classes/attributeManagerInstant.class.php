...
//-----------------------------
    ...
    $this->getAndPrepare('pa_qty', $get, $pa_qty);
    $this->getAndPrepare('pa_article', $get, $pa_article);
...
//-----------------------------
			...
			$queryString .= " LEFT JOIN " . TABLE_PRODUCTS_OPTIONS_VALUES . " pov ON pov.products_options_values_id = pa.options_values_id and pov.language_id = po.language_id";
			$queryString .= " where products_id = '$this->intPID' AND po.language_id=".(int)$this->getSelectedLanaguage()." order by ";
			$queryString .= !AM_USE_SORT_ORDER ?  "products_options_name, pa.products_attributes_id" : "pov.products_options_values_sort_order";
//----------------------------
// EOF Change: download attributes for AM
//-----------------------------
        ...
        $this->arrAllProductOptionsAndValues[$optionsId]['values'][$res['options_values_id']]['pa_qty'] = $res['pa_qty'];
        $this->arrAllProductOptionsAndValues[$optionsId]['values'][$res['options_values_id']]['pa_article'] = $res['pa_article'];
