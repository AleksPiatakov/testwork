...
$file = DIR_FS_EXT . "specials/admin/specials.php";

if (is_file($file) && getConstantValue('SPECIALS_MODULE_ENABLED') == 'true') {
    require_once($file);
} else {
    ...
    <table class="table_specials" border="0" width="100%" cellspacing="2" cellpadding="2">
        ...
        <tr>
            <td align="center" class="main">
                <?= getTextForDisabledModule(BOX_CATALOG_SPECIALS, is_file($file)) ?>
            </td>
        </tr>
    </table>
<?php
