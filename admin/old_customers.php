...
//   $gro_name = '<b>Неподтвержденные</b>. <br><br>Теперь вы не сможете видеть цены на товары.';
//else $gro_name = '<b>Оптовые покупатели</b>. <br>Теперь вы сможете видеть все цены на товары, качать прайс, делать заказы онлайн. ';
