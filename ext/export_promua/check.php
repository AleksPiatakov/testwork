...
if (!defined('EXPORT_PROMUA_MODULE_ENABLED')) {
    /**
    ...
    tep_db_query("INSERT INTO " . TABLE_CONFIGURATION . "
        (configuration_title,
         ...
         set_function)
         VALUES
        ('Модуль экспорта PromUa',
        'EXPORT_PROMUA_MODULE_ENABLED',
        'export_promua:false',
        'Модуль экспорта PromUa',
        '277',
        '1',
        ...
        'tep_cfg_select_option(array(\"export_promua:true\", \"export_promua:false\"),')
        ");
