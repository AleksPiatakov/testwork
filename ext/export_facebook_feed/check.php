...
if (!defined('EXPORT_FACEBOOK_FEED_MODULE_ENABLED')) {
    ...
    tep_db_query("INSERT INTO " . TABLE_CONFIGURATION . "
        (configuration_title,
         ...
         set_function)
         VALUES
        ('Модуль FACEBOOK_FEED',
        'EXPORT_FACEBOOK_FEED_MODULE_ENABLED',
        'export_facebook_feed:false',
        'Модуль Google Feed',
        '277',
        '1',
        '" . date('Y-m-d H:i:s') . "',
        ...
        'tep_cfg_select_option(array(\"export_facebook_feed:true\", \"export_facebook_feed:false\"),')
        ");
