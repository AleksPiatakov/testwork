...
if (!defined('YANDEX_MARKET_MODULE_ENABLED')) {
    /**
    ...
    tep_db_query("INSERT INTO " . TABLE_CONFIGURATION . "
        (configuration_title,
         ...
         set_function)
         VALUES
        ('Модуль экспорта Yandex Market',
        'YANDEX_MARKET_MODULE_ENABLED',
        'yandex_market:true',
        'Модуль экспорта Yandex Market',
        '277',
        '1',
        ...
        'tep_cfg_select_option(array(\"yandex_market:true\", \"yandex_market:false\"),')
        ");
