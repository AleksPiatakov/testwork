...
if (!defined('EXPORT_HOTLINE_MODULE_ENABLED')) {
    /**
    ...
    tep_db_query("INSERT INTO " . TABLE_CONFIGURATION . "
        (configuration_title,
         ...
         set_function)
         VALUES
        ('Модуль экспорта Hotline',
        'EXPORT_HOTLINE_MODULE_ENABLED',
        'export_hotline:false',
        'Модуль экспорта Hotline',
        '277',
        '1',
        '" . date('Y-m-d H:i:s') . "',
        ...
        'tep_cfg_select_option(array(\"export_hotline:true\", \"export_hotline:false\"),')
        ");
