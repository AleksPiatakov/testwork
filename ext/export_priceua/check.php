...
if (!defined('EXPORT_PRICEUA_MODULE_ENABLED')) {
    /**
    ...
    (configuration_title,
     ...
     set_function)
     VALUES
    ('Модуль экспорта PriceUa',
    'EXPORT_PRICEUA_MODULE_ENABLED',
    'export_priceua:false',
    'Модуль экспорта PriceUa',
    '277',
    '1',
    '" . date('Y-m-d H:i:s') . "',
    ...
    'tep_cfg_select_option(array(\"export_priceua:true\", \"export_priceua:false\"),')
    ");
