...
//      $this->credit_class = true;
  ...
  // Check if gift voucher is in cart and adjust total
    ...
    static function install()
    {
        ...
        tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Порядок сортировки', 'MODULE_ORDER_TOTAL_OT_PAYMENT_SORT_ORDER', '799', 'Порядок сортировки модуля обязательно должен быть ниже чем модуль Всего.', '6', '2', now())");
