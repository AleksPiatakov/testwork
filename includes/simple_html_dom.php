...
class simple_html_dom
{
    ...
    protected $optional_closing_tags = array(
        // Not optional, see
        // http://www.w3.org/TR/html/textlevel-semantics.html#the-b-element
        'b' => array('b' => 1),
        'dd' => array('dd' => 1, 'dt' => 1),
        // Not optional, see
        // http://www.w3.org/TR/html/grouping-content.html#the-dl-element
        'dl' => array('dd' => 1, 'dt' => 1),
        'dt' => array('dd' => 1, 'dt' => 1),
        'li' => array('li' => 1),
    ...
    protected function parse_charset()
    {
        ...
        if (empty($charset)) {
            // http://www.w3.org/TR/html/document-metadata.html#statedef-http-equiv-content-type
        ...
        if (empty($charset)) {
            // http://www.w3.org/TR/html/document-metadata.html#character-encoding-declaration
