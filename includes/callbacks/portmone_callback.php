...
if (!empty($_POST) && $_POST['SHOPBILLID'] && $_POST['RESULT'] == 0) {
    ...
    tep_db_perform('orders', ['orders_status' => MODULE_PAYMENT_PORTMONE_ORDER_STATUS_ID], 'update', "orders_id='" . $order_id . "'");
    tep_db_perform('orders_status_history', [
        'orders_id' => $order_id,
        'orders_status_id' => MODULE_PAYMENT_PORTMONE_ORDER_STATUS_ID,
        'date_added' => 'now()',
        'customer_notified' => '0',
        'comments' => 'Portmone - success!'
    ]);
