...
VALUES ('Часовий пояс', 'STORE_TIME_ZONE', '18', 'Часовий пояс', 1, 4,'2022-08-17 09:00:00', '2022-08-17 09:00:00', 'tep_get_time_zone_name', 'tep_cfg_pull_down_time_zone_list(','', 0);
...
ALTER TABLE `time_zones` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
INSERT INTO `time_zones` (`code`, `value`) VALUES
