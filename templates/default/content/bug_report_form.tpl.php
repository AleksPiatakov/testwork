...
<form action="ajax.php" id="BugReportForm">
    ...
    <div class="text-center row">
        <div class="form-group col-sm-9 center-block">
            <input type="hidden" placeholder="" name="request" value="BugReportProccess"> <textarea name="report_text"
                                                                                                    required
                                                                                                    class="bug-report-text form-control"
                                                                                                    placeholder="<?php echo ENTRY_REPORT_TEXT; ?>"
                                                                                                    rows="10"></textarea>
        </div>
    </div>
