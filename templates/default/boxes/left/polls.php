...
if (basename($PHP_SELF) != 'pollbooth.php') {
    ...
    if ($pollid) {
        ...
        $query = tep_db_query(
            "select pollid, optiontext, optioncount, voteid from " . TABLE_PHESIS_POLL_DATA . " where pollid=" . $pollid . " and voteid!=0 and language_id=" . $languages_id . " ORDER BY voteid asc"
        );
