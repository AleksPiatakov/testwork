...
<div class="col-sm-4 col-xs-12">
    <div class="section_top_footer">
        ...
        <a href="#" class="toggle-xs" title="<?php echo FOOTER_ARTICLES; ?>" data-target="#footer_articles"></a>
        <nav class="list_footer" id="footer_articles">
            ...
            <?php if (count((array)getArticles($config['id']['val'] ?: 13, 10)) > 7) {
                echo '<a class="show_all" href="' . tep_href_link(
                    FILENAME_ARTICLES,
                    'tPath=13'
                ) . '">' . SHOW_ALL_ARTICLES . '</a>';
            } ?>
