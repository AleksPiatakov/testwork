...
<!--        <a rel="nofollow" href="https://vk.com/share.php?url=--><?php //echo HTTP_SERVER; ?><!--" class="social_header_vk">-->
...
<!--        </a>-->
        ...
        <a rel="nofollow" href="<?php echo $config['instagram']['val']; ?>"
           class="social_header_instagram" title="instagram" target="_blank">
        ...
        <a rel="nofollow" href="<?php echo $config['youtube']['val']; ?>"
           class="social_header_youtube" title="youtube" target="_blank">
        ...
        <a rel="nofollow" href="<?php echo $config['telegram']['val']; ?>"
           title="telegram" class="social_header_telegram">
        ...
        <a rel="nofollow" href="<?php echo $config['facebook']['val']; ?>"
           title="facebook" class="social_header_facebook" target="_blank">
