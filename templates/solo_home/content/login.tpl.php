    ...
    <div class="row">
        <div class="col-md-6 col-xs-12 col-sm-6">
            ...
            <div class="form-group" style="margin-top: 36px;">
                <a rel="nofollow" class="btn login_btn" href="<?php echo tep_href_link(
        ...
        <div class="col-md-6 col-xs-12 col-sm-6">
            ...
            <div class="form-group row btns_group">
                ...
                <div class="col-sm-6 col-xs-12 text-right">
                    <button type="submit"
                            class="btn btn-default login_btn pull-right"><?php echo IMAGE_BUTTON_LOGIN; ?></button>
                </div>
            </div>
        </div>
    </div>
