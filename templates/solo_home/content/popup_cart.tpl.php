<?php if ($cart->count_contents() > 0) { ?>
    ...
    <div id="cartContent-page" class="container">
        ...
        <?php foreach ($html as $key => $value) : ?>
            <div class="row cartContent_body product_id_<?= $value['id'] ?>">
                <div class="col-sm-2 col-xs-12 product_image"><?php echo '<a href="' . tep_href_link(
                    FILENAME_PRODUCT_INFO,
                    'products_id=' . $value['id']
                                                              ) . '"><img src="getimage/80x80/products/' . $value['image'] . '" class="img-responsive"></a>'; ?></div>
                ...
                <div class="col-md-5 col-sm-6 col-xs-12 cartContent_body-numeric">
                    <div class="row">
                        ...
                        <div class="col-xs-4 product_qty"><?php echo '<input type="number" name="cart_quantity[]" value="' . $value['qty'] . '" class="form-control inputnumber" min="1" max="100000" />
                        ...
                        <div class="col-xs-2 product_delete"><?php echo '<span style="visibility: hidden;">
                                                             ...
                                                             <button class="delete btn btn-sm btn-danger" value="' . urlencode(
                                                                ...
                                                                <svg role="img" xmlns="hthttp://www.w3.org/2000/svg" viewBox="0 0 448 512">
