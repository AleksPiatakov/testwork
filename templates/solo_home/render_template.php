...
$rtpl = [
    ...
    'RTPL_PRODUCTS_SPEC_PRICE' => '<span class="new_price red_price">%s</span><span class="old_price">%s</span>',
    'RTPL_PRODUCTS_PRICE' => '<span class="new_price">%s</span>',
    'RTPL_PRODUCTS_OLD_PRICE' => '<span class="old-price-label">%s</span>',
    'RTPL_CART_BUTTON' => '<a class="btn btn-primary popup_cart added2cart" data-id="%s" href="/"><svg role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M352 128C352 57.421 294.579 0 224 0 153.42 0 96 57.421 96 128H0v304c0 44.183 35.817 80 80 80h288c44.183 0 80-35.817 80-80V128h-96zM224 32c52.935 0 96 43.065 96 96H128c0-52.935 43.065-96 96-96zm192 400c0 26.467-21.533 48-48 48H80c-26.467 0-48-21.533-48-48V160h64v48c0 8.837 7.164 16 16 16s16-7.163 16-16v-48h192v48c0 8.837 7.163 16 16 16s16-7.163 16-16v-48h64v272z"></path></svg>' . HOME_IMAGE_BUTTON_IN_CART . '</a>',
    ...
    ) . '"><svg role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M352 128C352 57.421 294.579 0 224 0 153.42 0 96 57.421 96 128H0v304c0 44.183 35.817 80 80 80h288c44.183 0 80-35.817 80-80V128h-96zM224 32c52.935 0 96 43.065 96 96H128c0-52.935 43.065-96 96-96zm192 400c0 26.467-21.533 48-48 48H80c-26.467 0-48-21.533-48-48V160h64v48c0 8.837 7.164 16 16 16s16-7.163 16-16v-48h192v48c0 8.837 7.163 16 16 16s16-7.163 16-16v-48h64v272z"></path></svg>' . HOME_IMAGE_BUTTON_IN_CART . '</a>',
    'RTPL_ADD_TO_CART_BUTTON' => '<button class="btn btn-primary add2cart" data-id="%s" data-qty="%s"><svg role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M352 128C352 57.421 294.579 0 224 0 153.42 0 96 57.421 96 128H0v304c0 44.183 35.817 80 80 80h288c44.183 0 80-35.817 80-80V128h-96zM224 32c52.935 0 96 43.065 96 96H128c0-52.935 43.065-96 96-96zm192 400c0 26.467-21.533 48-48 48H80c-26.467 0-48-21.533-48-48V160h64v48c0 8.837 7.164 16 16 16s16-7.163 16-16v-48h192v48c0 8.837 7.163 16 16 16s16-7.163 16-16v-48h64v272z"></path></svg>' . HOME_IMAGE_BUTTON_ADDTO_CART . '</button>',
    'RTPL_ADD_TO_CART_BUTTON_PRODUCT_PAGE' => '<button type="submit" class="btn-primary buy"><svg role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M352 128C352 57.421 294.579 0 224 0 153.42 0 96 57.421 96 128H0v304c0 44.183 35.817 80 80 80h288c44.183 0 80-35.817 80-80V128h-96zM224 32c52.935 0 96 43.065 96 96H128c0-52.935 43.065-96 96-96zm192 400c0 26.467-21.533 48-48 48H80c-26.467 0-48-21.533-48-48V160h64v48c0 8.837 7.164 16 16 16s16-7.163 16-16v-48h192v48c0 8.837 7.163 16 16 16s16-7.163 16-16v-48h64v272z"></path></svg>' . HOME_IMAGE_BUTTON_ADDTO_CART . '</button>',
    'RTPL_ADD_TO_CART_BUTTON_MODAL' => '<button type="submit" class="btn btn-primary buy">' . IMAGE_BUTTON_ADDTO_CART . '</button>',
    'RTPL_PRODUCTS_COMPARE' => '<a data-id="%s" class="compare_button" href="#"><input type="checkbox" id="compare_%s" name="compare_%s" %s /><label for="compare_%s">%s</label></a>',
    'RTPL_PRODUCTS_WISHLIST' => '<a data-id="%s" class="wishlisht_button" href="#"><input type="checkbox" class="wishlist_%s" name="wishlist_%s" %s /><label for="wishlist_%s">%s</label></a>',
