    <div class="product-main-info">
        ...
        echo tep_draw_form(
            ...
            'post',
            'data-cart-key="' . $cart_key . '" class="col-sm-12 col-md-8 product-info-render"'
        );
        ?>
        <div class="">
            <div class="row">
                <!-- PRODUCT INFO DESCRIPTION -->
                <div class="p_main-info">
                    <div class="description_card_product">
                                    ...
                                    <div class="social-widgets">
                                        <div class="dropdown dropdown-share-btn ">
                                            ...
                                            <ul class="dropdown-menu stop_propagation dropdown-menu-right">
                                                ...
                                                <li>
                                                    <input type="text" name="product_link" autocomplete="off"
                                                           id="p_link"
                                                           value="<?php echo HTTP_SERVER . $_SERVER['REQUEST_URI']; ?>"
                                                           onkeypress="return false;"
                                                           class="product_link input_select_all">
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                        ...
                        <div class="product-name-price">
                            ...
                            <?php endif ?>
                            <div class="p_info_item prod_buy_buttons">
                                        ...
                                        <div class="product-quantity-selector">
                                          <span class="quantity-selector-mask">
                                              <input type="number" id="" class="input-text qty text" step="1" min="1"
                                                     max="999" name="cart_quantity" value="1" size="4" pattern="[0-9]*"
                                ...
                                <?php else : ?>
                                    <?php if ($template->show("P_SHOW_QUANTITY_INPUT") == 0) { ?>
                                        <div class="product-quantity-selector">
                                          <span class="quantity-selector-mask">
                                              <input type="hidden" id="" class="input-text qty text" step="1" min="1"
                                                     max="999" name="cart_quantity" value="1" size="4" pattern="[0-9]*"
                                                     inputmode="numeric" aria-labelledby="">
                                          </span>
                                        </div>
                                ...
                                <?php echo tep_draw_hidden_field(
                                    'cart_quantity',
                        ...
                        <?php if ($attr_string and $template->show('P_ATTRIBUTES')) : ?>
        ...
        <div class="col-sm-12 col-md-4 p_sticky-image">
            <div class="row">
                <div class="">
                    <!-- PRODUCT INFO SLIDER -->
        ...
        <div class="col-sm-12 col-md-8 p_tabs">
