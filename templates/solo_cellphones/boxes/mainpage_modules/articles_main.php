...
if (is_array($art_array)) {
    foreach ($art_array as $articles) {
        ...
        $output .= '
  								<article>
  									<img src="' . DIR_WS_IMAGES_CDN . 'pixel_trans.png" data-src="' . $art_image . '" alt="' . $atr_name . '" class="lazyload">
  									<div class="info">
                                        <time datetime="' . date(
                                        'Y-m-d',
                                        strtotime($atr_date)
...
<div class="row row_news_customer_reviews">
    ...
    <?php } ?>
            ...
            <div class="news">
                <div class="like_h2">
                    <?php echo $topicName;?>
                    <a href="<?php echo tep_href_link(FILENAME_ARTICLES, 'tPath=' . $news_category); ?>" class="view-all-btn" data-toggle="tooltip" data-placement="auto right" title="<?php echo mb_ucfirst_custom(FILTER_ALL." ".$topicName); ?>"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
