<?php if (COMPARE_MODULE_ENABLED == 'true') { ?>
    <div id="compare_box">
        ...
        if (isset($_SESSION['compares']) && (count($_SESSION['compares']) > 0)) {
            ...
            ?>
            <div class="dropdown">
                <div class="compare-icon dropdown-toggle" data-toggle="dropdown">
                        ...
                        <div class="body">
                            ...
                            foreach ($_SESSION['compares'] as $key => $val) {
                                ...
                                if ($i <= 3) {
                                  ...
                                  <span class="image-previewer"><img src="' . DIR_WS_IMAGES_CDN . 'pixel_trans.png" data-src="getimage/260x260/products/' . $compare_prod_img[0] . '" alt="" class="lazyload image-previewer-src"></span>
                                </div>';
                                    //Name
