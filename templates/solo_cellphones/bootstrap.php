...
//if ($template->getMainconf('MC_SLIDER_POSITION') == 2) $main_container = 'body-full-width';
...
$assets->cssInline[] = ':root {
      ...
      .product {height:' . (SMALL_IMAGE_HEIGHT + 140) . 'px;}
      .product_slider {height:' . (SMALL_IMAGE_HEIGHT + 145) . 'px;}';
