...
$rtpl = [
    ...
    'RTPL_PRODUCTS_COMPARE' => '<a data-id="%s" class="item compare-button compare_button" href="#"><input type="checkbox" id="compare_%s" name="compare_%s" %s /><label for="compare_%s" data-toggle="tooltip" data-placement="auto top" title="' . COMPARE . '">%s</label></a>',
    'RTPL_PRODUCTS_WISHLIST' => '<a data-id="%s" class="item favorite-button wishlisht_button" href="#"><input type="checkbox" id="wishlist_%s" name="wishlist_%s" %s /><label for="wishlist_%s" data-toggle="tooltip" data-placement="auto top" title="' . WHISH . '">%s</label></a>',
