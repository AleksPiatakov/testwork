        ...
        <form class="col-md-5" role="form" name="account_edit" method="POST"
            ...
            <div class="form-group">
                ...
                <input type="text" required name="firstname" class="form-control"
                       value="<?php echo $account['customers_firstname']; ?>" id="customers_firstname"
            ...
            <div class="form-group">
                ...
                <input type="text" required name="lastname" class="form-control"
                       value="<?php echo $account['customers_lastname']; ?>" id="customers_lastname"
                       placeholder="<?php echo ENTRY_LAST_NAME; ?>">
            </div>
            <?php if (ACCOUNT_DOB == 'true') : ?>
                <div class="form-group">
                    <label><?php echo ENTRY_DATE_OF_BIRTH; ?></label>
                    <input type="text" name="dob" class="form-control" value="<?php echo $account['customers_dob']; ?>"
