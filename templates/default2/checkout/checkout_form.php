            ...
            <div class="col-lg-7  col-xs-12">
                ...
                <div class="collapse_wrapper open">
                    ...
                    <div class="collapse_wrapper_info short_info" style="display: none" data-parent="#checkout_user">
                        <span data-selector="input[name='shipping_firstname']"></span> <span
                                data-selector="input[name='shipping_lastname']"></span> (<span
                                data-selector="input[name='billing_telephone']"></span>) <span
                                data-selector="input[name='billing_email_address']"></span><br> <span
                                data-selector="input[name='shipping_street_address']"></span>, <span
                                data-selector="input[name='shipping_city']"></span>, <span
                                data-selector="select[name='shipping_country']"></span>
                    </div>
                    <div class="collapse_wrapper_billing_info short_info" style="display: none"
                         data-parent="#checkout_user">
                        <span data-selector="input[name='billing_firstname']"></span> <span
                                data-selector="input[name='billing_lastname']"></span> <span
                                data-selector="input[name='billing_street_address']"></span>,<br> <span
                                data-selector="input[name='billing_city']"></span>, <span
                                data-selector="select[name='billing_country']"></span>
                    </div>
