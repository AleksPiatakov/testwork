...
if ((!empty($_GET['cPath']) or isset($_GET['manufacturers_id']) or isset($_GET['keywords'])) and ATTRIBUTES_PRODUCTS_MODULE_ENABLED == 'true') {
    if (defined('SEO_FILTER') && constant('SEO_FILTER') == 'true') {
        require(DIR_WS_TEMPLATES . 'default2/boxes/left/filter_seo.php');
    } else {
    global $currency;
    if (!isset($config)) {
        ...
        <div class="filter_box_in">
            ...
            if ($config['price_range']['val'] == 1) {
                ...
                $priceRangeFilterHtml .= '<div class="dipcen">
                             <div class="filter_heading">' . COMP_PROD_PRICE . '<span class="price_fltr">' . ($currencies->currencies[$currency]['symbol_left'] ? $currencies->currencies[$currency]['symbol_left'] : $currencies->currencies[$currency]['symbol_right']) . '</span></div>
                             <div id="slider-range"></div>
                             <div class="price_range_block">
                                 <span class="left slider-from">
                                   <input type="number" min="0" class="input-type-number-custom" id="range1" value="' . (!empty($_GET['rmin']) ? $_GET['rmin'] : $listing_sql_max['min_price'] + 0) . '"  />
                                 </span>
            ...
            if ($config['manufacturers']['val'] == 1 && tep_db_num_rows($manuf_sql)) {
                $manufacturersFilterHtml .= '<div class="attrib_divs ajax">
                          <div id="ajax_search_brands" class="block">
                            <div class="filter_heading collapsed" data-toggle="collapse" data-target="#filter_brands">' . FILTER_BRAND . '<svg role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M441.9 167.3l-19.8-19.8c-4.7-4.7-12.3-4.7-17 0L224 328.2 42.9 147.5c-4.7-4.7-12.3-4.7-17 0L6.1 167.3c-4.7 4.7-4.7 12.3 0 17l209.4 209.4c4.7 4.7 12.3 4.7 17 0l209.4-209.4c4.7-4.7 4.7-12.3 0-17z"></path></svg></div>
                              <div class="filter_content collapse " id="filter_brands">
                              <div class="inner-scroll" id="filter_brands">
                                <div class="item">
                ...
                if (is_array($attrs_array)) {
                    ...
                    foreach ($attrs_array as $at_id) {
                        ...
                        if (is_array($show_in_filter) and in_array($at_id, $show_in_filter)) {
                            ...
                            $attributesFilterHtml .= '<div class="filter_accordion">';
                            $attributesFilterHtml .= '<span class="filter_heading collapsed" data-toggle="collapse" data-target="#filter_' . $filter_counter . '">' . $attr_names_array[$at_id] . '<svg role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M441.9 167.3l-19.8-19.8c-4.7-4.7-12.3-4.7-17 0L224 328.2 42.9 147.5c-4.7-4.7-12.3-4.7-17 0L6.1 167.3c-4.7 4.7-4.7 12.3 0 17l209.4 209.4c4.7 4.7 12.3 4.7 17 0l209.4-209.4c4.7-4.7 4.7-12.3 0-17z"></path></svg></span>';
                            $attributesFilterHtml .= '<div class="filter_content collapse" id="filter_' . $filter_counter . '">';
