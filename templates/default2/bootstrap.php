...
if (
    (is_array($cPath_array) and count(
        $cPath_array
    ) and !isset($_GET['products_id'])) or isset($_GET['manufacturers_id'])
) {
    $sidebar_left = true;
}
// IF PRODUCT INFO
if ($content == 'checkout' || $content == 'compare') {
    $sidebar_left = false;
    $show_breadcrumbs = true;
}
...
$assets->fonts[] = DIR_WS_TEMPLATES . TEMPLATE_NAME . '/fonts/Roboto/Roboto-Thin.ttf';
$assets->fonts[] = DIR_WS_TEMPLATES . TEMPLATE_NAME . '/fonts/Roboto/Roboto-Light.ttf';
$assets->fonts[] = DIR_WS_TEMPLATES . TEMPLATE_NAME . '/fonts/Roboto/Roboto-Regular.ttf';
$assets->fonts[] = DIR_WS_TEMPLATES . TEMPLATE_NAME . '/fonts/Roboto/Roboto-Medium.ttf';
$assets->fonts[] = DIR_WS_TEMPLATES . TEMPLATE_NAME . '/fonts/Roboto/Roboto-Bold.ttf';
...
$assets->css[] = DIR_WS_TEMPLATES . TEMPLATE_NAME . '/css/bootstrap4.min.css';
$assets->css[] = DIR_WS_TEMPLATES . TEMPLATE_NAME . '/stylesheet2.css'; // <!-- default css -->
$assets->css[] = DIR_WS_TEMPLATES . TEMPLATE_NAME . '/css/OverlayScrollbars.min.css';
...
$assets->cssInline[] = ':root {
            ...
            --sm-height-product: ' . (SMALL_IMAGE_HEIGHT + 130) . 'px;
            --sm-height-left-product: ' . (SMALL_IMAGE_HEIGHT + 160) . 'px;
               }
              ...
              @media (max-width:356px) {
                .product {height:' . (SMALL_IMAGE_HEIGHT + 190) . 'px;}
                .product_slider {height:' . (SMALL_IMAGE_HEIGHT + 200) . 'px;}
              }';
...
$assets->js[] = 'includes/javascript/Popper.js';
$assets->js[] = 'includes/javascript/OverlayScrollbars/jquery.overlayScrollbars.min.js';
$assets->js[] = 'includes/javascript/bootstrap4.min.js';
...
if (
    $file = $template->getFiles(
        'MAINPAGE',
        'M_SLIDE_MAIN',
        $config
    ) && ($content == 'index_default' || MINIFY_CSSJS == 1)
) {
