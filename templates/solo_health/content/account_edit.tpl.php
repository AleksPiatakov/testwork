        ...
        <form class="col-md-5" role="form" name="account_edit" method="POST"
            ...
            <div class="form-group">
                ...
                <input type="text" required name="email_address" class="form-control"
                       value="<?php echo $account['customers_email_address']; ?>" id="customers_email_address"
            ...
            <div class="form-group">
                ...
                <input type="text" required name="firstname" class="form-control"
                       value="<?php echo stripslashes($account['customers_firstname']); ?>" id="customers_firstname"
            ...
            <div class="form-group">
                ...
                <input type="text" required name="lastname" class="form-control"
                       value="<?php echo stripslashes($account['customers_lastname']); ?>" id="customers_lastname"
                       placeholder="<?php echo ENTRY_LAST_NAME; ?>">
            </div>
            <?php if (ACCOUNT_DOB == 'true') : ?>
                <div class="form-group">
                    <label><?php echo ENTRY_DATE_OF_BIRTH; ?></label>
                    <input type="text" name="dob" class="form-control account-edit-datepicker" value="<?php echo date("Y-m-d", strtotime($account['customers_dob'])); ?>"
                           id="customers_dob" placeholder="<?php echo ENTRY_DATE_OF_BIRTH; ?>">
                </div>
            <?php endif; ?>
            <!--     <div class="form-group">
  <label><?php //echo ENTRY_EMAIL_ADDRESS; ?></label>
  <input type="email" required name="email_address" class="form-control" value="<?php //echo $account['customers_email_address']; ?>" id="customers_email_address" placeholder="<?php //echo ENTRY_EMAIL_ADDRESS; ?>">
</div> -->
            <div class="form-group">
                <label><?php echo ENTRY_TELEPHONE_NUMBER; ?></label>
                <input type="text" name="telephone" class="form-control"
                       value="<?php echo $account['customers_telephone']; ?>" id="customers_telephone"
