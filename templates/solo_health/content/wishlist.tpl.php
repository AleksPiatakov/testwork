...
if (is_array($wishList->wishID) && !empty($wishList->wishID)) {
    ...
    <div class="wishlist-table white-rounded-box">
        <div class="like_h2">
            <!--            <a class="remove-all-btn" href="-->
            <?php //echo tep_href_link('compare.php','action=compare&delete=all'); ?><!--"><span>-->
            <?php //= COMP_PROD_CLEAR; ?><!--</span></a>-->
            <?= HEADING_TITLE; ?>
            <!--            <a class="btn-link go-back-btn" href="javascript:history.back()">-->
            <?php //echo COMP_PROD_BACK;?><!--</a>-->
        </div>
