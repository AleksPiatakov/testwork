<div class="login-page-box white-rounded-box">
    <?php
    ...
    <form name="login" action="<?php echo tep_href_link(FILENAME_LOGIN, 'action=process', 'SSL'); ?>" role="form">
        <?= csrf() ?>
        <div class="row">
            <div class="col-md-6 col-xs-12 col-sm-6 login-register-link">
            ...
            <div class="col-md-6 col-xs-12 col-sm-6 login-already-registered">
