...
$assets->css[] = DIR_WS_TEMPLATES . TEMPLATE_NAME . '/css/font-awesome.min.css';
$assets->cssInline[] = ':root {
      ...
      .p_img_href_list{max-width: ' . (SMALL_IMAGE_WIDTH - 50) . 'px;}
      .product {height:' . (SMALL_IMAGE_HEIGHT + 140) . 'px;}
      .product_slider {height:' . (SMALL_IMAGE_HEIGHT + 150) . 'px;}';
