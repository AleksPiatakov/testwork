...
$rtpl = array(
    'RTPL_PRODUCTS_IMAGE' => '<img src="' . DIR_WS_IMAGES_CDN . 'pixel_trans.png" data-src="getimage/%s/products/%s" alt="%s" title="' . IMAGE_BUTTON_ADDTO_CART . ' %s" %s height="' . SMALL_IMAGE_HEIGHT . '" width="' . SMALL_IMAGE_WIDTH . '"/>',
    ...
    'RTPL_PRODUCTS_OUTSTOCK' => '<span class="label %s label-black laebel-nostock">' . LIST_TEMP_OUTSTOCK . '</span>',
    ...
    'RTPL_CART_BUTTON' => '<a class="btn btn-primary popup_cart added2cart" data-id="%s" href="/">' . IMAGE_BUTTON_IN_CART . '</a>',
    ...
    'RTPL_ADD_TO_CART_BUTTON_PRODUCT_PAGE' => '<button type="submit" class="btn-primary buy">' . IMAGE_BUTTON_ADDTO_CART . '</button>',
    'RTPL_ADD_TO_CART_BUTTON_MODAL' => '<button type="submit" class="btn btn-primary buy">' . IMAGE_BUTTON_ADDTO_CART . '</button>',
    'RTPL_PRODUCTS_COMPARE' => '<span data-id="%s" class="compare_button"><input type="checkbox" id="compare_%s" name="compare_%s" %s />%s<label for="compare_%s">%s</label>%s</span>',
    ...
    'RTPL_PRODUCTS_ATTR_LISTING_COL' => '<tr><td><span>%s:</span><br />%s</td></tr>',
