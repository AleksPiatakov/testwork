...
<?php } else { ?>
    ...
    for ($i = 0, $n = sizeof($quotes); $i < $n; $i++) {
        if (isset($quotes[$i]['methods']) && count($quotes[$i]['methods']) > 1) {
            echo '<div class="row shippingModuleHeadingRow"><div class="col-sm-12"><b class="checkout_ship_header">' . $quotes[$i]['module'] . ':</b></div>';
        }
        if (isset($quotes[$i]['error'])) {
            ?>
            <div class="row">
                <div class="col-sm-12">
                    <span class="checkout_error"><?php echo sprintf(
            ...
            <?php
        } elseif (is_array($quotes[$i]['methods'])) {
