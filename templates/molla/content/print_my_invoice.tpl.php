...
<div class="address_block">
    ...
    <div class="border_radius" style="width: 100%; margin: 20px 0 0; padding: 10px 10px 10px 20px;">
        <div>
            ...
            <br>
            <strong><?php echo INVOICE_CUSTOMER_NUMBER; ?></strong> <?php echo INVOICE_TEXT_NUMBER_SIGN; ?><?php echo $customer_info['customers_id']; ?>
        </div>
    ...
    <tr>
        <td colspan="2" align="center">
            <table border="0" cellspacing="0" cellpadding="2" class="products_table">
                <tr>
                    <td width="20" align="left"><b><?php echo TABLE_HEADING_PRODUCTS_PC; ?></b></td>
                    <td width="60"><b><?php echo TABLE_HEADING_PRODUCTS_MODEL; ?></b></td>
                    <td width="120" align="left"><b><?php echo TABLE_HEADING_PRODUCTS; ?></b></td>
                    <td width="80" align="right"><b><?php echo TABLE_HEADING_TAX; ?></b></td>
                    <td width="80" align="right"><b><?php echo TABLE_HEADING_UNIT_PRICE; ?></b></td>
                    <td width="80" align="right"><b><?php echo TABLE_HEADING_TOTAL; ?></b></td>
                </tr>
                <?php
