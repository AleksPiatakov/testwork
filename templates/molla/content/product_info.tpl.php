                ...
                <div class="description_card_product row">
                    ...
                    <div class="col-sm-8">
                        <?php if ($template->show('P_PRESENCE')) {
                            ...
                            echo '<span class="label ' . ($product_info['products_quantity'] > 0 ? 'label-success' : 'label-danger') . '">' . $stock_text . '</span>';
                        } ?>
                    </div>
                    ...
                    <div class="prod_buy_btns col-sm-8 col-xs-7">
                        <?php if ($template->show(
                                "P_SHOW_QUANTITY_INPUT") and $product_info['products_quantity'] > 0): ?>
...
<ul class="nav nav-tabs content-tabs">
    ...
    <?php if ($template->show('P_TAB_DESCRIPTION')): ?>
        <li>
        <a data-toggle="tab" href="#tab-description"><?php echo TEXT_DESCRIPTION; ?></a>
        <span class="corner"></span></li><?php endif ?>
...
<div class="tab-content">
    ...
    <?php if ($template->show('P_TAB_DESCRIPTION')): ?>
        <div id="tab-description"
             class="tab-pane fade "><?php echo $product_info['products_description']; ?></div><?php endif ?>
