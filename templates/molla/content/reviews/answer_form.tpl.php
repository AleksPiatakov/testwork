<div class="comment-reply-block" style="display: none">
    ...
    <div class="row add-comment-row">
        <div class="col-md-4 comment-skin-body">
            ...
            <input type="hidden" name="parent_id" value="" class="form-control">
            <div class="form-group">
                <input class="form-control" placeholder="{{placeholderName}}" type="text" name="name"
                       id="nickAnswerForm" maxlength="40" value="{{customer_name}}" size="20">
            </div>
            ...
            <div class="form-group">
                <button type="button" class="btn btn-info" onclick="addReview('.comment-reply-block')">{{buttonSend}}
                </button>
                <button type="button" class="btn btn-info cancel-reply-to-comment">{{buttonCancel}}</button>
            </div>
        </div>
    </div>
</div>
