...
<div class="row">
    ...
    <div class="col-sm-6 form-group clearfix">
        <input type="text" name="name" class="form-group form-control" placeholder="<?= ENTRY_NAME ?>" required
               value="<?= $val_name ?>"/>
        <input name="email" type="email" class="form-group form-control" placeholder="<?= ENTRY_EMAIL ?>" required
               value="<?= $val_email ?>"/>
        <input name="phone" type="text" class="form-group form-control" placeholder="<?= ENTRY_PHONE ?>" required/>
        <textarea name="enquiry" maxlength="1000" class="form-group form-control" placeholder="<?= ENTRY_ENQUIRY ?>"
