                ...
                <div class="collapse_wrapper open">
                    ...
                    <div id="checkout_user" class="user_block collapse in">
                        <?php if ($customer_id == 0) : ?>
                            <div class="user_header">
                                ...
                                <input type="checkbox" name="registration-off"
                                       id="registration-off" <?= $checkboxState; ?>> <label
                                        for="registration-off"><?php echo TEXT_REGISTRATION_OFF; ?></label>
                            </div>
                        <?php endif; ?>
                        <div class="checkout_bottom">
                            ...
                            <input type="checkbox" name="diffShipping" id="diffShipping" <?= $checkboxState; ?>> <label
                                    for="diffShipping"><?php echo ONEPAGE_ADDRESS_TYPE_POSITION == 'billing_shipping' ? TEXT_DIFFERENT_BILLING : TEXT_DIFFERENT_SHIPPING; ?></label>
                ...
                <div class="text-center checkout_btn_block" id="checkoutYesScript" style="display:none;">
                    ...
                    if ($processButtonAvailable) { ?>
                        <div id="checkoutButtonContainer">
                                ...
                                </span> <input type="hidden" name="formUrl" id="formUrl" value="">
                        </div>
                        <?php
