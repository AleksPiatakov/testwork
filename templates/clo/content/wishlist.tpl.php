    ...
    <div class="container">
        <table id="wishlist_table" class="typical_table" width="100%">
            ...
            foreach ($wishList->wishID as $wishlist_id => $val) {
                ...
                ?>
                <tr>
                    <td valign="middle" class="productListing-data" align="left">
                    ...
                    <td valign="middle" class="productListing-data" align="left" class="main">
                        <b>
                            <a href="<?php echo tep_href_link(
                                FILENAME_PRODUCT_INFO,
                                'products_id=' . $wishlist_id,
                        ...
                        if ($cart->in_cart($wishlist_id)) {
                            echo '<br /><span>(' . TEXT_ITEM_IN_CART . ')</span>';
                        }
                    ...
                    <td valign="middle" class="productListing-data"><?php echo $products_price; ?></td>
                    <td valign="middle" class="productListing-data">
                        <?php echo '<a class="btn btn-default gradient" href="' . tep_href_link(
                            'wishlist.php',
                            'delete_prod=' . $wishlist_id
                        ) . '">' . IMAGE_BUTTON_DELETE . '</a>'; ?>
                    </td>
                    <td valign="middle" class="productListing-data" align="center">
                        <?php
