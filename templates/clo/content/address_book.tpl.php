...
?>
    <div id="address_book" class="clearfix">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            if ($addresses['address_book_id'] == $customer_default_address_id) {
                                echo '<span class="label label_primary">' . PRIMARY_ADDRESS . '</span>';
                            }
                            ?>
                            <div class="btn-group pull-right">
                                <?php echo '<a class="btn btn-group btn-danger btn-xs" href="' . tep_href_link(
                                    ...
                                    'SSL'
                                ) . '">                        <svg role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512"><path d="M207.6 256l107.72-107.72c6.23-6.23 6.23-16.34 0-22.58l-25.03-25.03c-6.23-6.23-16.34-6.23-22.58 0L160 208.4 52.28 100.68c-6.23-6.23-16.34-6.23-22.58 0L4.68 125.7c-6.23 6.23-6.23 16.34 0 22.58L112.4 256 4.68 363.72c-6.23 6.23-6.23 16.34 0 22.58l25.03 25.03c6.23 6.23 16.34 6.23 22.58 0L160 303.6l107.72 107.72c6.23 6.23 16.34 6.23 22.58 0l25.03-25.03c6.23-6.23 6.23-16.34 0-22.58L207.6 256z"></path></svg></a>
        ...
        <div class="clearfix">
            <?php echo '<a class="btn btn-default" href="' . tep_href_link(
                FILENAME_ACCOUNT,
                '',
                'SSL'
            ) . '">' . IMAGE_BUTTON_BACK . '</a>'; ?>
            <?php if (tep_count_customer_address_book_entries() < MAX_ADDRESS_BOOK_ENTRIES) { ?>
                <span class="right">
                <?php echo '<a class="btn btn-danger" href="' . tep_href_link(
                    FILENAME_ADDRESS_BOOK_PROCESS,
                    '',
                    'SSL'
