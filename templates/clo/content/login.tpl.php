<div class="container">
    <div class="row">
        <div class="col-xs-12">
            ...
            <form name="login" action="<?php echo tep_href_link(FILENAME_LOGIN, 'action=process', 'SSL'); ?>"
                  role="form">
                <?= csrf() ?>
                    ...
                    <div class="col-md-6 col-xs-12 col-sm-6">
                        ...
                        <div class="form-group" style="margin-top: 36px;">
                            <a rel="nofollow" class="btn btn-success" href="<?php echo tep_href_link(
                                'create_account.php'
                            ); ?>"><?php echo IMAGE_BUTTON_CONTINUE; ?></a>
                        </div>
                    </div>
                    <div class="col-md-6 col-xs-12 col-sm-6">
                        ...
                        <div class="form-group">
                            <?php echo '<a rel="nofollow" class="btn btn-link btn-xs" href="' . tep_href_link(
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-default"><?php echo SEND_MESSAGE; ?></button>
                        </div>
                        <?php if (
                            (DIR_WS_EXT . "auth/ajax_loginfb.php" or DIR_WS_EXT . "auth/ajax_login_google.php")
                            and AUTH_MODULE_ENABLED == 'true'
                            and (FACEBOOK_AUTH_STATUS == "true" or GOOGLE_OAUTH_STATUS == 'true')
                        ) { ?>
                            <p class="or"><?php echo HEADER_TITLE_OR; ?></p>
                            <div class="row social-button-login">
                                <?php if (
                                    ...
                                    <div class="col-md-6 col-xs-12 col-sm-6">
                                        <a rel="nofollow"
                                           ...
                                           class="social_login social_header_facebook">
                                ...
                                <?php endif ?>
                                <?php if (GOOGLE_OAUTH_STATUS == 'true') { ?>
                                    <div class="col-md-6 col-xs-12 col-sm-6">
