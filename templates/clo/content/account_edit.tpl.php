...
<div class="row">
    <form class="col-md-5" role="form" name="account_edit" method="POST"
        ...
        <div class="form-group">
            ...
            <input type="text" required name="email_address"
                   class="form-control"
        ...
        <?php if (ACCOUNT_DOB == 'true') : ?>
            <div class="form-group">
                ...
                <input type="text" name="dob" class="form-control account-edit-datepicker"
                       value="<?php echo date("Y-m-d", strtotime($account['customers_dob'])); ?>"
                       id="customers_dob"
