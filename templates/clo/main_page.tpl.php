...
<head>
    ...
    <meta property="og:image"
          content="<?php echo !empty($product_info['products_image']) ? HTTP_SERVER . '/images/' . $product_info['products_image'] : LOGO_IMAGE; ?>"/>
    <?php
        ...
        <header>
            ...
            <div class="top_header">
                <div class="container container_top_header clearfix">
                    <div class="row">
                        <div class="col-xs-12 col-sm-5 header_mob">
                            <div class="lang_curr_block hidden-xs">
                            ...
                            <div class="header_actions visible-xs">
                                ...
                                <?php if ($template->checkModules('HEADER', 'H_SHOPPING_CART')) : ?>
                        ...
                        <div class="hidden-xs col-sm-2 top_header-last">
                            <?php require $template->requireBox('H_LOGIN'); ?>
                ...
                <div class="row row_menu_contacts_footer">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-xs-12">
                                <div class="row">
                                    <?php require $template->requireBox('F_TOP_LINKS'); ?>
                                    <div class="col-sm-6">
                                        <div class="phones_footer"><?php echo renderArticle('phones'); ?></div>
                                    </div>
                                </div>
                            </div>
                            <!-- END FOOTER INFO -->

                            <?php require $template->requireBox('F_ARTICLES_BOTTOM'); ?>
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <section class="copyright_info_footer">
                            <div class="copyright">
                                <p><?php echo FOOTER_ALLRIGHTS; ?>
                                    <a href="#" target="_blank" rel="nofollow"><?php echo STORE_NAME; ?></a>
