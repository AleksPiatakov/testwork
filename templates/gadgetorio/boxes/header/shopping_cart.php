...
if ($cart_count > 0) {
    ...
    $cart_output = '<div class="position-relative popup_cart cart-not-empty">
    ...
    $cart_output = '<div class="popup_cart">
...
$cart_output_mobile = '<a href="#" rel="nofollow" class="popup_cart basket_768 hidden">
