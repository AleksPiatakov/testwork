...
<div class="wishlist-icon">
    ...
    <div class="counter"><span><?php echo (is_array($wishList->wishID)) ? count($wishList->wishID) : 0; ?></span></div>
</div>
<div class="content">
    ...
    <div class="block-view-all">
        <a class="gocomparelink" href="<?php echo tep_href_link('wishlist.php'); ?>"><?php echo BOX_HEADING_WISHLIST; ?>
            <?php if (is_array($wishList->wishID)) {
