...
<div class="col-sm-12 col-md-12 product-info-render white-rounded-box">
    <div class="row">
        <div class="col-sm-12 col-xs-12 p_main-info p_header p_header_rel">
            ...
            <div class="p_info_item">
                <span id="summ_price" class="prod_price"><?php echo $products_price ?></span>
                ...
                <?php else : ?>
                    <div class="product-quantity-selector">
                                <span class="quantity-selector-mask">
                                    <input type="<?php echo $inp_type; ?>" id="" class="input-text qty text" step="1"
                                           min="1" max="999" name="cart_quantity" value="1" size="4" pattern="[0-9]*"
                        ...
                        <div class="container_sheare_compare">
                            ...
                            <?php if (
                                ...
                                <div id="compare_wishlist" class="compare compare_wishlist">
                                    <?php
                                    if (
                                        ($template->show('P_COMPARE')) && (defined(
                                                'COMPARE_MODULE_ENABLED'
                                            ) && COMPARE_MODULE_ENABLED == 'true')
                                    ) {
                                        echo sprintf(
        ...
        <div class="col-sm-12 col-xs-12">
            ...
            <div class="slider_product_card">
                <div class="additional_images2">
                    ...
                    $thumb_size_w = 260;
                    $thumb_size_h = 160;
                    include(DIR_WS_MODULES . 'additional_images2.php'); ?>
                </div>
        ...
        <div class="col-sm-12 col-xs-12 p_main-info p_body">
            <div class="description_card_product">
                <?php if (!empty($product_info['products_info']) and $template->show('P_SHORT_DESCRIPTION')) : ?>
                    <div class="product-name-price">
                        ...
                        <!--                                    <p>-->
                        <?php //echo strip_tags((mb_substr($product_info['products_description'], 0, 690, 'UTF-8')) . ((strlen($product_info['products_description']) >= 690) ? '...' : '')); ?><!--</p>-->
                        <!---->
                        <!--                                </div>-->
                        <!--                            --><?php //} elseif ($product_info['products_info']) {
                        //                                echo "<p>" . $product_info['products_info'] . "</p>";
                        //                            }
                        //                            ?>
                    ...
                    <div class="custom-description">
                        <?php if ($attr_string) { ?>
                            <div class="prod_attributes p_attr_text p_info_item">
                                ...
                                <span class="title"><?php echo TEXT_ATTRIBS; ?>:</span>
                                <div class="prod_attributes_div attrs-list">
