    ...
    <div class="compare-table white-rounded-box">
        ...
        <div class="compare-table-header">
            <div class="header-row">
                <?php
                if (!isMobile()) {
                    echo '<div class="row-cell title hidden-xs"></div>';
                }

                foreach ($cps as $key => $val) {
                    echo '<div class="row-cell ' . $product_class . ' col-xs-12">';
                    ...
                    echo '<a class="product-image" href="' . tep_href_link(
                        ...
                        ) . '"><img src="' . DIR_WS_IMAGES_CDN . 'pixel_trans.png" data-src="getimage/160x160/products/' . explode(
                            ';',
                            $val['products_image']
                        )[0] . '" alt="" class="lazyload"></a>';
