...
<div class="row">
    <div class="col-md-6 col-sm-12">
        ...
        <div class="form-group">
            <label for="password_current"><?php echo ENTRY_PASSWORD_CURRENT; ?></label>
        ...
        <div class="form-group">
            <label for="password_new"><?php echo ENTRY_PASSWORD_NEW; ?></label>
            <input type="password" name="password_new" class="form-control" id="password_new"
                   placeholder="<?php echo ENTRY_PASSWORD_NEW; ?>">
        </div>
        <div class="form-group">
            <label for="password_confirmation"><?php echo ENTRY_PASSWORD_CONFIRMATION; ?></label>
        ...
        <div class="form-group">
            ...
            <input class="btn btn-primary pull-right" type="submit" value="<?php echo IMAGE_BUTTON_CONTINUE; ?>">
        </div>
    </div>
</div>
</form>
