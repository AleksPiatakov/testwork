...
<div class="size1of2" style="margin: 0 auto;text-align: center;">
    ...
    <p><?php echo TEXT_SUCCESS_INFO; ?></p>
    ...
    <div>
        <input class="btn bold" type="submit" value="<?php echo IMAGE_BUTTON_CONTINUE; ?>"> <input
                id="successPageProductsIds" type="hidden"
                value="['<?php echo implode("','", $productsIdsForAnalyticsArray); ?>']"> <input
                id="successPageProductsPrices" type="hidden"
