...
<div class="row">
  ...
  <p><?php echo sprintf(TEXT_NEW_CUSTOMER_INTRODUCTION, STORE_NAME) ?></p>
    ...
    <div class="form-group" style="margin-top: 36px;">
      <a rel="nofollow" class="btn btn-success" href="<?php echo tep_href_link(FILENAME_CREATE_ACCOUNT, '', 'SSL');?>"><?php echo HEADER_TITLE_CREATE_ACCOUNT; ?></a>
    </div>
  </div>
  <div class="col-md-6 col-xs-12 col-sm-6">
    <h2><?php echo TEXT_RETURNING_CUSTOMER; ?></h2>
      <div class="form-group">
        <?php echo tep_draw_input_field('email_address','','class="reg_input form-control" autocomplete="off" placeholder="'.ENTRY_EMAIL_ADDRESS.'"'); ?>
      </div>
      <div class="form-group">
        <?php echo tep_draw_password_field('password','','class="reg_input form-control" autocomplete="off" placeholder="'.ENTRY_PASSWORD.'"'); ?>
      </div>
      <div class="form-group row">
        <div class="col-xs-6">
          <?php echo '<a rel="nofollow" href="' . tep_href_link(FILENAME_PASSWORD_FORGOTTEN, '', 'SSL') . '">' . TEXT_PASSWORD_FORGOTTEN . '</a>'; ?>
        </div>
          <div class="col-xs-12 networks-container">
          <?php if (AUTH_MODULE_ENABLED=='true' and $template->show('H_LOGIN_FB') and FACEBOOK_AUTH_STATUS=="true"): ?>
              <a rel="nofollow" href="javascript:showLoginvk('<?php echo 'https://www.facebook.com/dialog/oauth/?client_id=' . $fb_app_id . '&amp;display=popup&amp;redirect_uri=' . HTTP_SERVER . '/ext/auth/ajax_loginfb.php&amp;state=' . $fb_state . '&amp;scope=email,public_profile'; ?>');" class="social_header_facebook">
                  <svg role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                      <path d="M400 32H48A48 48 0 0 0 0 80v352a48 48 0 0 0 48 48h137.25V327.69h-63V256h63v-54.64c0-62.15 37-96.48 93.67-96.48 27.14 0 55.52 4.84 55.52 4.84v61h-31.27c-30.81 0-40.42 19.12-40.42 38.73V256h68.78l-11 71.69h-57.78V480H400a48 48 0 0 0 48-48V80a48 48 0 0 0-48-48z"></path>
                  </svg>
                  <?php echo RENDER_LOGIN_WITH; ?> Facebook</a>
          ...
          <?php if (AUTH_MODULE_ENABLED=='true' and GOOGLE_OAUTH_STATUS =='true'){ ?>
              <a rel="nofollow" href="javascript:startGoogleOAuth();" class="social_header_google googleSigninButton">
