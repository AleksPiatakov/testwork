            ...
            <div class="col-lg-5 col-xs-12">
                    ...
                    if ($processButtonAvailable) { ?>
                        ...
                        <div id="checkoutButtonContainer_minimal" style="display:none;color:#D40000;">
                            ...
                            <div class="right" style="padding:12px 20px 0 0;"><?php echo TEXT_MIN_SUM; ?>: <b>
                                    <span id="minimal_sum"></span></b> <?php echo($currencies->currencies[$currency]['symbol_left'] ? $currencies->currencies[$currency]['symbol_left'] : $currencies->currencies[$currency]['symbol_right']); ?>
                            </div>
                            <div class="clear"></div>
                        </div>
                    <?php } ?>
                ...
                <?php if (isMobile()) : ?>
                    <div class="mob_short_cart">
                        <span class="scroll_total"></span>
                        <span class="checkout_scroll"><?= IMAGE_BUTTON_CHECKOUT; ?></span>
                    </div>
                <?php endif; ?>
            </div>
        </div>
