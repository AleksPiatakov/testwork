...
namespace App\Classes\Filesystem;
...
class Filesystem
{
     ...
     * @throws Exception
     */
    public function prepend(string $path, $data): int
    {
        if ($this->exists($path)) {
    ...
    public function humanFilesize($bytes, $decimals = 2)
    {
        ...
        return Filesystem . phpsprintf("%.{$decimals}f", $bytes / pow(1024, $factor));
    }

    /**
     * Get the file permission of a given file.
     * @param string $path
     * @return int
     */
    ...
    /**
     * Get the file owner of a given file.
     * @param string $path
     * @return int
     */
    ...
    /**
     * Get the file group of a given file.
     * @param string $path
     * @return int
     */
